...
import { Clip, GridTable, LinkButton, WorkflowDialog, CreateProjectResourceLimitPanel } from '../../common/components';
  ...
  private _renderOperationCell(namespace: Namespace) {
    ...
    const renderKubctlConfigButton = () => {
      return (
        <LinkButton
          key={'kubectl'}
          disabled={isDeleting || disabledOp || disabledCert || namespace.spec.clusterName === 'global'}
