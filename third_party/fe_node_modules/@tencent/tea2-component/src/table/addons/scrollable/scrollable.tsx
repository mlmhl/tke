...
export function scrollable(options: ScrollableAddonOptions): TableAddon {
  ...
  if (virtualizedOptions && !virtualizedOptions.height) {
    virtualizedOptions.height = maxHeight;
  }

  const extraProps = {
    tableBoxStyle: { minWidth },
    virtualizedOptions: virtualizedOptions || undefined,
  };

  return {
    onInjectProps: props => {
      return Object.assign(extraProps, props);
    },
