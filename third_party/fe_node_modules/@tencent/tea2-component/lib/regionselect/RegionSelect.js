...
function RegionSelect(props) {
    ...
    return (react_1.default.createElement(dropdown_1.Dropdown, tslib_1.__assign({}, dropdownProps, { boxAdaptable: true, appearance: "button", className: classnames_1.default(classPrefix + "-dropdown--region-select", dropdownProps.className), button: react_1.default.createElement(react_1.default.Fragment, null,
            selectedOption && react_1.default.createElement(RegionOption_1.RegionOption, tslib_1.__assign({}, selectedOption)),
            moreInfo && (react_1.default.createElement("div", { className: classPrefix + "-region__more" }, moreInfo))) }), react_1.default.createElement(RegionOption_1.RegionOptionContext.Provider, { value: {
            inject: function (props) {
                return tslib_1.__assign(tslib_1.__assign({}, props), { selected: value === props.value, onClick: function (event) {
