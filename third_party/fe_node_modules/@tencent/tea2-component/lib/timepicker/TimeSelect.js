...
function TimeSelect(_a) {
    ...
    return (react_1.default.createElement(list_1.List, { ref: selectRef, type: "option", className: classPrefix + "-list--calendar-time" }, genRangeList().map(function (item) {
        var disabled = disabledValues.includes(item);
        return (react_1.default.createElement(list_1.List.Item, { key: item, className: classnames_1.default({
                "is-disabled": disabled,
                "is-selected": !disabled && item === value,
            }), onClick: function (e) { return !disabled && handleSelect(e, item); } },
            react_1.default.createElement("div", { className: classPrefix + "-list__item" }, item > 9 ? "" + item : "0" + item)));
    })));
}
