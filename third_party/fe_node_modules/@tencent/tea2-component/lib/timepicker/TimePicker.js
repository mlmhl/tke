...
exports.TimePicker = with_statics_1.withStatics(function TimePicker(props) {
    ...
    return (react_1.default.createElement(Popover_1.Popover, { trigger: [
            ...
            react_1.default.createElement(CalendarPart_1.default.Panel, { timeMode: true },
                ...
                react_1.default.createElement(CalendarPart_1.default.Footer, { right: react_1.default.createElement(button_1.Button, { type: "primary", onClick: handleOk, disabled: !curValue }, t.okText) }))) },
        react_1.default.createElement("div", { className: classnames_1.default(classPrefix + "-timepicker", className), style: style },
            react_1.default.createElement("div", { className: classPrefix + "-timepicker__input" },
