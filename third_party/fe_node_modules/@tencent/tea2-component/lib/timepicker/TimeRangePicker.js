...
exports.TimeRangePicker = with_statics_1.withStatics(function TimeRangePicker(props) {
    ...
    var _a = controlled_1.useDefaultValue(props, [null, null]), className = _a.className, style = _a.style, value = _a.value, onChange = _a.onChange, disabled = _a.disabled, _b = _a.separator, separator = _b === void 0 ? "~" : _b, _c = _a.format, format = _c === void 0 ? "HH:mm:ss" : _c, _d = _a.placeholder, placeholder = _d === void 0 ? t.selectTime : _d, _e = _a.defaultOpen, defaultOpen = _e === void 0 ? false : _e, open = _a.open, _f = _a.onOpenChange, onOpenChange = _f === void 0 ? function () { return null; } : _f, _g = _a.placement, placement = _g === void 0 ? "bottom-start" : _g, _h = _a.placementOffset, placementOffset = _h === void 0 ? 5 : _h, _j = _a.closeOnScroll, closeOnScroll = _j === void 0 ? true : _j, escapeWithReference = _a.escapeWithReference, overlayClassName = _a.overlayClassName, overlayStyle = _a.overlayStyle, range = _a.range, _k = _a.disabledTime, disabledTime = _k === void 0 ? function () { return ({}); } : _k, _l = _a.hourStep, hourStep = _l === void 0 ? 1 : _l, _m = _a.minuteStep, minuteStep = _m === void 0 ? 1 : _m, _o = _a.secondStep, secondStep = _o === void 0 ? 1 : _o, disableAutoAdjust = _a.disableAutoAdjust, _p = _a.caption, caption = _p === void 0 ? [t.selectTime, t.selectTime] : _p;
    // 当前选中时间
    var _q = tslib_1.__read(react_1.useState(isValidRangeValue(value)
        ? [value[0].clone(), value[1].clone()]
        : [null, null]), 2), curValue = _q[0], setCurValue = _q[1];
    // 选择器是否展开
    var _r = tslib_1.__read(use_default_1.useDefault(open, defaultOpen, onOpenChange), 2), active = _r[0], setActive = _r[1];
    // 输入框显示值
    ...
    var _s = tslib_1.__read(react_1.useState(getInputValue(curValue)), 2), inputValue = _s[0], setInputValue = _s[1];
    ...
    return (react_1.default.createElement(Popover_1.Popover, { trigger: [
            ...
            react_1.default.createElement(CalendarPart_1.default.Panel, { rangeMode: true, timeMode: true },
                react_1.default.createElement(CalendarPart_1.default.Body, null,
                    react_1.default.createElement(CalendarTable_1.CalendarTable, tslib_1.__assign({}, props, { rangeType: "start", type: "time", showTime: tslib_1.__assign(tslib_1.__assign({}, timeProps), { caption: Array.isArray(caption) ? caption[0] : null }), value: curValue, onChange: handleChange })),
                    react_1.default.createElement(CalendarTable_1.CalendarTable, tslib_1.__assign({}, props, { rangeType: "end", type: "time", showTime: tslib_1.__assign(tslib_1.__assign({}, timeProps), { caption: Array.isArray(caption) ? caption[1] : null }), value: curValue, onChange: handleChange }))),
        ...
        react_1.default.createElement("div", { className: classnames_1.default(classPrefix + "-timepicker", className), style: style },
            react_1.default.createElement("div", { className: classPrefix + "-timepicker__input size-l" },
