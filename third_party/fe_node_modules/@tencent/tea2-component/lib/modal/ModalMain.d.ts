 ...
 * 模态对话框组件
 */
export declare function Modal({ visible, caption, size, onClose, onExited, disableEscape, disableCloseIcon, maskClosable, destroyOnClose, className, style, children, }: ModalProps): React.ReactPortal;
