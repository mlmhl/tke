...
function confirm(options) {
    return new Promise(function (resolve) {
        ...
        react_dom_1.default.render(react_1.default.createElement(configprovider_1.ConfigProvider, null,
            react_1.default.createElement(ModalConfirmAPI, tslib_1.__assign({}, options, { onOk: function () { return resolve(true); }, onCancel: function () { return resolve(false); }, onExited: function () {
...
function ModalConfirm(_a) {
    var message = _a.message, description = _a.description, modalProps = tslib_1.__rest(_a, ["message", "description"]);
...
function ModalButton(_a) {
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement(button_1.Button, { type: "primary", onClick: onOk, ref: mainButtonRef }, okText || t.okText),
