...
function CalendarTable(_a) {
    ...
    var tableProps = tslib_1.__assign(tslib_1.__assign({}, props), { range: range,
        onTypeChange: onTypeChange, current: curViewMoment, onCurrentChange: onCurViewMomentChange });
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        ...
        react_1.default.createElement(ScaleTransition_1.ScaleTransition, { in: type === "date", exit: false, from: ZOOM_IN },
            react_1.default.createElement(DateTable_1.DateTable, tslib_1.__assign({}, tableProps, { value: getValue(), disabledDate: function (date) {
                    ...
                    if (moment_1.isMoment(value[0]) &&
                        !moment_1.isMoment(value[1]) &&
                        moment_1.isMoment(hovered)) {
                        if (value[0].isBefore(date) && hovered.isAfter(date)) {
                            return BaseTable_1.CellStatus.InRangeHover;
                        }
