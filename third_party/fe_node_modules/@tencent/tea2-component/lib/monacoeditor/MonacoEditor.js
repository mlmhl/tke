...
var MonacoDiffEditor_1 = require("./MonacoDiffEditor");
exports.MonacoEditor = forward_ref_with_statics_1.forwardRefWithStatics(function MonacoEditor(_a, ref) {
    var monaco = _a.monaco, _b = _a.options, options = _b === void 0 ? {} : _b, language = _a.language, className = _a.className, style = _a.style, width = _a.width, height = _a.height, props = tslib_1.__rest(_a, ["monaco", "options", "language", "className", "style", "width", "height"]);
    ...
    react_1.useLayoutEffect(function () {
        var editor = monaco.editor.create(containerRef.current, tslib_1.__assign(tslib_1.__assign({}, options), { value: value,
            language: language }));
        editorRef.current = editor;
        changeEventRef.current = editor.onDidChangeModelContent(function (event) {
            if (!preventTriggerChangeEvent.current) {
                onChange(editor.getValue(), { event: event });
            }
        });
        return function () {
    ...
    DiffEditor: MonacoDiffEditor_1.MonacoDiffEditor,
});
