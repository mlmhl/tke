...
exports.BubbleContent = react_1.forwardRef(function (props, ref) {
    ...
    if (tooltip) {
        return (react_1.default.createElement("div", tslib_1.__assign({ className: classPrefix + "-tooltip", ref: ref }, htmlProps),
            react_1.default.createElement("div", { className: classPrefix + "-tooltip__inner" }, children)));
    }
    return (react_1.default.createElement("div", tslib_1.__assign({ ref: ref, className: classnames_1.default((_a = {},
            ...
            _a)) }, htmlProps),
        react_1.default.createElement("div", { className: classPrefix + "-bubble__inner" }, children)));
});
