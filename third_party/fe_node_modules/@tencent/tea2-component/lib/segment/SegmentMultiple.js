...
function SegmentMain(_a) {
    ...
    // 兼容分组
    valueSet = _a.valueSet, _c = _a.allOptions, allOptions = _c === void 0 ? options : _c;
    ...
    return (react_1.default.createElement("div", { className: classnames_1.default(classPrefix + "-segment", className, (_b = {},
            ...
            _b)), style: style }, options.map(function (option) { return (react_1.default.createElement(button_1.Button, { key: option.value, disabled: option.disabled, tooltip: option.tooltip, className: classnames_1.default({
