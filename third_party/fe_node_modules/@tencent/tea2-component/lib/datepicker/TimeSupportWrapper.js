...
function TimeSupportWrapper(_a) {
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        ...
        react_1.default.createElement(CalendarPart_1.default.Footer, { left: react_1.default.createElement("div", { className: classPrefix + "-date-status" }, isTimeType() ? (react_1.default.createElement(button_1.Button, { type: "link", onClick: function () { return setType("date"); }, style: { textDecoration: "none" } }, t.selectDate)) : (react_1.default.createElement(button_1.Button, { type: "link", onClick: function () { return setType("time"); }, disabled: !hasValue(value), style: { textDecoration: "none" } }, t.selectTime))), right: react_1.default.createElement(button_1.Button, { type: "primary", onClick: onOk, disabled: !hasValue(value) }, t.okText) })));
}
