...
exports.DatePicker = with_statics_1.withStatics(function DatePicker(props) {
    ...
    var _a = controlled_1.useDefaultValue(props), header = _a.header, className = _a.className, style = _a.style, showTime = _a.showTime, value = _a.value, onChange = _a.onChange, disabled = _a.disabled, _format = _a.format, _b = _a.placeholder, placeholder = _b === void 0 ? showTime ? t.selectTime : t.selectDate : _b, _c = _a.defaultOpen, defaultOpen = _c === void 0 ? false : _c, open = _a.open, _d = _a.onOpenChange, onOpenChange = _d === void 0 ? noop_1.noop : _d, _e = _a.placement, placement = _e === void 0 ? "bottom-start" : _e, _f = _a.placementOffset, placementOffset = _f === void 0 ? 5 : _f, _g = _a.closeOnScroll, closeOnScroll = _g === void 0 ? true : _g, escapeWithReference = _a.escapeWithReference, overlayClassName = _a.overlayClassName, overlayStyle = _a.overlayStyle, clearable = _a.clearable, restProps = tslib_1.__rest(_a, ["header", "className", "style", "showTime", "value", "onChange", "disabled", "format", "placeholder", "defaultOpen", "open", "onOpenChange", "placement", "placementOffset", "closeOnScroll", "escapeWithReference", "overlayClassName", "overlayStyle", "clearable"]);
    var _h = tslib_1.__read(react_1.useState(false), 2), hover = _h[0], setHover = _h[1];
    var format = _format || getFormat(showTime);
    // 当前面板类型
    var _j = tslib_1.__read(react_1.useState("date"), 2), type = _j[0], setType = _j[1];
    // 当前面板展示时间
    var _k = tslib_1.__read(react_1.useState(moment_1.isMoment(value) ? value : getDefaultViewMoment()), 2), curViewMoment = _k[0], setCurViewMoment = _k[1];
    // 当前选中日期
    ...
    function syncDate(value, type) {
        ...
        if (moment_1.isMoment(preValidValue)) {
            ...
            if (typeof showTime === "object" && moment_1.isMoment(showTime.defaultValue)) {
                value.set(util_1.getHourMinuteSecond(showTime.defaultValue));
            }
    ...
    function getDefaultViewMoment() {
        ...
        if (!time) {
            ...
            m = moment_1.default(util_1.getHourMinuteSecond(time));
        }
        // range 判断
    ...
    return (react_1.default.createElement(popover_1.Popover, { trigger: [
        ...
        react_1.default.createElement("div", { className: classnames_1.default(classPrefix + "-datepicker", className), style: style },
            react_1.default.createElement("div", { className: classnames_1.default(classPrefix + "-datepicker__input", {
