...
function useVisibleTransition(visible) {
    /**
     ...
     */
    var _a = tslib_1.__read(react_1.useState(visible), 2), contentIn = _a[0], setContentIn = _a[1];
...
exports.useVisibleTransition = useVisibleTransition;
