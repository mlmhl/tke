...
function CheckboxGroup(props) {
    ...
    var context = {
        inject: function (checkProps) {
            ...
            return tslib_1.__assign(tslib_1.__assign({}, checkProps), { value: checkedSet.has(checkName), disabled: checkProps.disabled || disabled, display: layout === "column" ? "block" : "inline", onChange: function (checked, context) {
    ...
    return (react_1.default.createElement("div", { className: classnames_1.default(classPrefix + "-form-check-group", className), style: style },
