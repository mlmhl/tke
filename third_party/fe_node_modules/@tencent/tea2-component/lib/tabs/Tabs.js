...
function Tabs(_a) {
    ...
    var containerClassName = classnames_1.default(classPrefix + "-tabs", (_b = {},
        // 垂直布局
        _b[classPrefix + "-tabs--vertical"] = placement === "left",
        _b[classPrefix + "-tabs--ceiling"] = ceiling,
        _b[className] = className,
        _b));
    return (react_1.default.createElement("div", { className: containerClassName, style: style },
        react_1.default.createElement(TabBar_1.TabBar, { tabs: tabs, activeId: activeId, onActive: onActive, addon: addon, vertical: placement === "left", maxHeight: maxHeight, tabBarRender: tabBarRender, style: tabBarStyle }),
        getTabPanels()));
}
exports.Tabs = Tabs;
