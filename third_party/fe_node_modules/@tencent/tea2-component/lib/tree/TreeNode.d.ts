...
export declare function TreeNodeInner({ id, content, icon, operation, selectable, activable, activeIds, onActive, expandable, children, expandedIds, onExpand, onLoad, onLoadError, switcherIcon, pure, className, style, }: TreeNodeProps & TreeContextValue): JSX.Element;
