...
function TreeView(_a) {
    var _b;
    var selectable = _a.selectable, selectStrictly = _a.selectStrictly, selectedIds = _a.selectedIds, _c = _a.defaultSelectedIds, defaultSelectedIds = _c === void 0 ? [] : _c, onSelect = _a.onSelect, activable = _a.activable, activeIds = _a.activeIds, _d = _a.defaultActiveIds, defaultActiveIds = _d === void 0 ? [] : _d, onActive = _a.onActive, expandedIds = _a.expandedIds, _e = _a.defaultExpandedIds, defaultExpandedIds = _e === void 0 ? [] : _e, _f = _a.onExpand, onExpand = _f === void 0 ? function () { return null; } : _f, onLoad = _a.onLoad, onLoadError = _a.onLoadError, switcherIcon = _a.switcherIcon, className = _a.className, style = _a.style, children = _a.children;
    var classPrefix = config_context_1.useConfig().classPrefix;
    var childrenMap = react_1.useRef(new Map());
    var _g = tslib_1.__read(react_1.useState({}), 2), relations = _g[0], setRelations = _g[1];
    var _h = tslib_1.__read(react_1.useState([]), 2), disabledIds = _h[0], setDisabledIds = _h[1];
    var _j = tslib_1.__read(use_default_1.useDefault(selectedIds, defaultSelectedIds, onSelect), 2), selectedNodes = _j[0], setSelectedNodes = _j[1];
    var _k = tslib_1.__read(use_default_1.useDefault(activeIds, defaultActiveIds, onActive), 2), activeNodes = _k[0], setActiveNodes = _k[1];
    var _l = tslib_1.__read(use_default_1.useDefault(expandedIds, defaultExpandedIds, onExpand), 2), expandedNodes = _l[0], setExpandedNodes = _l[1];
        ...
        if (selectable) {
            ...
            if (!selectStrictly) {
                ...
                traverse(undefined, children, {
                    ...
                    disabledIds: disabledIds_1,
                });
                setRelations(relations_1);
            }
            else {
                traverse(undefined, children, {
                    relations: {},
            ...
            setDisabledIds(disabledIds_1);
        }
    }, [children, selectStrictly, selectable]);
    return (react_1.default.createElement("div", { className: classnames_1.default(classPrefix + "-tree", className, (_b = {},
            _b[classPrefix + "-tree--checkbox-separate"] = selectable && activable,
            _b)), style: style },
