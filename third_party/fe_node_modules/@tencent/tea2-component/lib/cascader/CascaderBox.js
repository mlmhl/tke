...
function CascaderBox(_a) {
    var data = _a.data, value = _a.value, onChange = _a.onChange, onLoad = _a.onLoad, onClose = _a.onClose, changeOnSelect = _a.changeOnSelect, className = _a.className, style = _a.style, scheduleUpdate = _a.scheduleUpdate, classPrefix = _a.classPrefix, multiple = _a.multiple, isSelected = _a.isSelected, onDeselect = _a.onDeselect;
    // 内部状态
    ...
    return (react_1.default.createElement(Dropdown_1.DropdownBox, { className: className, style: style },
        react_1.default.createElement("div", { className: classnames_1.default(classPrefix + "-cascader-menu", classPrefix + "-cascader-menu__col" + ((panels[curPanelIndex] &&
                panels[curPanelIndex].col) ||
                4)) },
            react_1.default.createElement(tabs_1.Tabs, { className: classPrefix + "-tabs--bordered", animated: false, activeId: String(curPanelIndex), onActive: function (_a) {
                    var id = _a.id;
                ...
                return (react_1.default.createElement(tabs_1.TabPanel, { id: String(index), key: index }, options ? (react_1.default.createElement("ul", { className: classPrefix + "-cascader-menu__list" }, options.map(function (_a) {
                    var value = _a.value, label = _a.label, child = _a.child;
                    var optionValue = tslib_1.__spread(internalValue.slice(0, index), [
                        value,
                    ]);
                    return (react_1.default.createElement("li", { key: value },
                        react_1.default.createElement("div", { className: classnames_1.default(classPrefix + "-cascader-menu__label", {
                ...
                }))) : (react_1.default.createElement("ul", { className: classPrefix + "-cascader-menu__list", style: { margin: 0 } },
