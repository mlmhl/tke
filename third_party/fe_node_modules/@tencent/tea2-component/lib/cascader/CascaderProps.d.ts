...
export interface CascaderBaseProps extends Combine<CommonDropdownProps, StyledProps> {
    /**
     * 选择数据
     */
    data: CascaderData;
 ...
 * 单选模式
 */
export interface CascaderSingleProps extends ControlledProps<string[], React.SyntheticEvent, {
 ...
 * 多选模式
 */
export interface CascaderMultipleProps extends ControlledProps<string[][], React.SyntheticEvent, {
    options: CascaderOption[][];
    event: React.MouseEvent;
}> {
}
export declare type CascaderProps = Combine<CascaderBaseProps, CascaderSingleProps | CascaderMultipleProps>;
