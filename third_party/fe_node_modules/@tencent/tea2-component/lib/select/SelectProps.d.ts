 ...
 */
export declare type SelectProps = NativeSelectProps | SimulateSelectProps;
interface CommonSelectProps extends Combine<StyledProps, ControlledProps<string>> {
    /**
     * 下拉选项列表
     */
 ...
 * 模拟单选 Props
 */
export interface SimulateSelectProps extends Combine<CommonSelectProps, SelectSearchProps<SelectOptionWithGroup>, CommonDropdownProps> {
    /**
