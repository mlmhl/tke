...
var ValueSelect = /** @class */ (function (_super) {
    ...
    ValueSelect.prototype.render = function () {
        ...
        var _c = this.props, type = _c.type, inputValue = _c.inputValue, onChange = _c.onChange, onSelect = _c.onSelect, onCancel = _c.onCancel, offset = _c.offset, maxHeight = _c.maxHeight, render = _c.render;
        var props = {
            values: values,
        ...
        if (render) {
            return (react_1.default.createElement(dropdown_1.DropdownBox, { style: { left: offset }, onClick: function (e) { return e.stopPropagation(); } }, render({ inputValue: inputValue, onSelect: onSelect, onCancel: onCancel })));
        }
