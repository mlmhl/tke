...
var TagInput = /** @class */ (function (_super) {
    ...
    TagInput.prototype.render = function () {
        ...
        var _b = this.props, classPrefix = _b.config.classPrefix, active = _b.active, attributes = _b.attributes, isFocused = _b.isFocused, hidden = _b.hidden, maxWidth = _b.maxWidth, type = _b.type;
        ...
        var input = type !== "edit" ? (react_1.default.createElement("input", { ref: function (input) { return (_this["input"] = input); }, type: "text", className: classPrefix + "-input " + classPrefix + "-input--tag", placeholder: "", style: {
            ...
            react_1.default.createElement("textarea", { ref: function (input) { return (_this["input"] = input); }, className: classPrefix + "-input " + classPrefix + "-input--tag", placeholder: "", style: {
        ...
        return (react_1.default.createElement(overlay_1.Overlay, { layers: [
                react_1.default.createElement(overlay_1.Overlay.Layer, { key: "edit", placementOffset: type === "edit" ? 12 : 2, transitionTimeout: { enter: 50, exit: 0 }, overlayProps: {
                        ...
                        return (react_1.default.createElement(react_1.default.Fragment, null,
                            ...
                            showValueSelect && !!attribute && !!attribute.type && (react_1.default.createElement(ValueSelect_1.ValueSelect, { type: attribute.type, ref: function (select) { return (_this["value-select"] = select); }, values: attribute.values, render: attribute.render, inputValue: valueStr.trim(), offset: ValueSelectOffset, onChange: _this.handleValueChange, onSelect: _this.handleValueSelect, onCancel: _this.handleValueCancel, maxHeight: maxHeight }))));
                    } }),
