...
var Tag = /** @class */ (function (_super) {
    ...
    Tag.prototype.render = function () {
        ...
        var _a = this.props, t = _a.t, classPrefix = _a.config.classPrefix, active = _a.active, attr = _a.attr, values = _a.values, dispatchTagEvent = _a.dispatchTagEvent, attributes = _a.attributes, focused = _a.focused, maxWidth = _a.maxWidth;
        ...
        return (react_1.default.createElement("div", { style: {
            ...
            react_1.default.createElement(bubble_1.Bubble, { content: active ? t.tagSearchBoxEditingTips : null },
                react_1.default.createElement("div", { className: classPrefix + "-tag", ref: function (div) { return (_this["content"] = div); }, style: {
