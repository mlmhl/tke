...
function FormItem(_a) {
    ...
    return (react_1.default.createElement(FormContext_1.FormContext.Consumer, null, function (_a) {
        ...
        return (react_1.default.createElement("div", { className: classnames_1.default(classPrefix + "-form__item", className), style: style },
            !hideLabel && (react_1.default.createElement("div", { className: classnames_1.default(classPrefix + "-form__label", {
            ...
            react_1.default.createElement(FormControl_1.FormControl, { status: status, showStatusIcon: showStatusIcon, message: message, alignLabelTop: isAlignLabelTop(align, children) },
                children,
                suffix && (react_1.default.createElement("div", { className: classPrefix + "-form__help-text--inline" }, suffix)))));
    }));
}
