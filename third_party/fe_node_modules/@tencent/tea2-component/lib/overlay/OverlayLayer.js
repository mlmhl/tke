...
function OverlayLayer(_a) {
    ...
    escapeWithReference = _a.escapeWithReference, _g = _a.modifiers, modifiers = _g === void 0 ? {} : _g;
    var classPrefix = config_context_1.useConfig().classPrefix;
    // visible 启动时，才开始渲染内容，进行动画
    var _h = use_visible_transition_1.useVisibleTransition(visible), shouldContentRender = _h.shouldContentRender, shouldContentEnter = _h.shouldContentEnter, onContentExit = _h.onContentExit;
    if (!shouldContentRender) {
        return null;
    }
    // 渲染定位组件
    return react_dom_1.default.createPortal(react_1.default.createElement(react_popper_1.Popper, { referenceElement: referenceElement, placement: placement, modifiers: tslib_1.__assign({ offset: {
                enabled: true,
        ...
        var overlayContent = inject_value_1.injectValue(content)(tslib_1.__assign(tslib_1.__assign({}, popper), { visible: visible }));
        return (react_1.default.createElement(transition_1.ScaleTransition, { from: animationScaleFrom, origin: scaleOriginForPlacement(placement), timeout: transitionTimeout, in: shouldContentEnter, onEnter: function () { return popper.scheduleUpdate(); }, onExited: onContentExit },
            react_1.default.createElement("div", tslib_1.__assign({}, overlayProps, { 
                ...
                className: classnames_1.default(classPrefix + "-overlay", overlayProps.className), 
