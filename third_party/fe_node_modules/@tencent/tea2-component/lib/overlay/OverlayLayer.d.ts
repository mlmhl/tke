 ...
 *
  ...
  ```
 */
export declare function OverlayLayer({ content, overlayRef, overlayProps, placement, visible, placementOffset, transitionTimeout, updateOnDimensionChange, referenceElement, animationScaleFrom, // 为什么？因为此时效果比较好
escapeWithReference, modifiers, }: OverlayLayerProps): React.ReactPortal;
