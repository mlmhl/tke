...
function Tabs(_a) {
    ...
    var _f = tslib_1.__read(react_1.useState(defaultActiveId), 2), internalActiveId = _f[0], setInternalActiveId = _f[1];
    // 非受控模式下，使用内部状态
    if (typeof activeId === "undefined") {
        // eslint-disable-next-line no-param-reassign
    ...
    function getTabPanels() {
        ...
        react_1.default.Children.forEach(children, function (child, index) {
            if (is_child_of_type_1.isChildOfType(child, TabPanel_1.TabPanel)) {
                ...
                if ((destroyInactiveTabPanel && active) ||
    ...
    return (react_1.default.createElement("div", { className: containerClassName, style: style },
        react_1.default.createElement(TabBar_1.TabBar, { tabs: tabs, activeId: activeId, onActive: onActive, addon: addon, vertical: placement === "left", maxHeight: maxHeight }),
        getTabPanels()));
}
exports.Tabs = Tabs;
