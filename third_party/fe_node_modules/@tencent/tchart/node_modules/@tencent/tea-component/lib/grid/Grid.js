...
function Row(_a) {
    ...
    rowStyle = tslib_1.__assign({}, (rowStyle || {}), (style || {}));
    var rowClassName = classnames_1.default("tea-grid", className, (_b = {
            "tea-grid--split-line": showSplitLine
        },
        _b["tea-vertical--" + verticalAlign] = verticalAlign,
        _b));
...
function Col(_a) {
    ...
    var colClassName = classnames_1.default("tea-grid__item" + (span ? "-" + span : ""), className);
    colStyle = tslib_1.__assign({}, (colStyle || {}), (style || {}));
    return (react_1.default.createElement("div", { className: colClassName, style: colStyle },
        react_1.default.createElement("div", { className: "tea-grid__box" }, children)));
}
exports.Col = Col;
