...
export default function Table({ caption, children, jumperOptions, type, }: TableProps): JSX.Element;
export default namespace Table {
    var Row: typeof TableRow;
    var Cell: typeof Cell;
}
...
export declare function Cell({ name, value, onSelect, onOutsideSelect, isNow, outside, disabled, status, }: Cell): JSX.Element;
