...
var defaultPageSizeOptions = [10, 20, 30, 50, 100, 200];
var noop = function () { };
function Pagination(_a) {
    ...
    var stateElement = (function () {
        ...
        return (react_1.default.createElement("div", { className: "tea-pagination__state" },
            react_1.default.createElement("span", { className: "tea-pagination__text" }, typeof stateText === "undefined"
    ...
    if (pageIndexVisible !== false) {
        operatationElements = [
            react_1.default.createElement(PageIndexInput, { key: "page-index-input", pageIndex: pageIndex, pageCount: pageCount, onChange: changePageIndex }),
        ];
    }
    // 页码跳转
    if (jumpVisible !== false) {
        operatationElements = tslib_1.__spread([
            react_1.default.createElement(PaginationButton, { key: "jump-prev", type: "pre", icon: "arrowleft", disabled: pageIndex <= 1, title: pageIndex > 1 ? t.paginationPrevPage : t.paginationAtFirst, onClick: function () { return changePageIndex(pageIndex - 1); } })
        ], operatationElements, [
            react_1.default.createElement(PaginationButton, { key: "jump-next", type: "next", icon: "arrowright", disabled: pageIndex >= pageCount, title: pageIndex < pageCount ? t.paginationNextPage : t.paginationAtLast, onClick: function () { return changePageIndex(pageIndex + 1); } }),
        ]);
    }
    // 页头页尾跳转
    if (endJumpVisible !== false) {
        operatationElements = tslib_1.__spread([
            react_1.default.createElement(PaginationButton, { key: "jump-first", type: "first", icon: "firstpage", disabled: pageIndex <= 1, title: pageIndex > 1 ? t.paginationToFirstPage : t.paginationAtFirst, onClick: function () { return changePageIndex(1); } })
        ], operatationElements, [
            react_1.default.createElement(PaginationButton, { key: "jump-last", type: "last", icon: "lastpage", disabled: pageIndex >= pageCount, title: pageIndex < pageCount ? t.paginationToLastPage : t.paginationAtLast, onClick: function () { return changePageIndex(pageCount); } }),
        ]);
    }
    // 页长选择
    if (pageSizeVisible !== false) {
        operatationElements = tslib_1.__spread([
            react_1.default.createElement("span", { key: "page-size-text", className: "tea-pagination__text" }, t.paginationRecordPerPage),
    ...
    return (react_1.default.createElement("div", { className: classnames_1.default("tea-pagination", className), style: style },
        stateElement,
        react_1.default.createElement("div", { className: "tea-pagination__operate" }, operatationElements)));
}
exports.Pagination = Pagination;
function PaginationButton(_a) {
    var _b;
    var type = _a.type, disabled = _a.disabled, icon = _a.icon, title = _a.title, onClick = _a.onClick;
    var buttonClassName = classnames_1.default((_b = {
            "tea-pagination__turnbtn": true
        },
        _b["tea-pagination__" + type + "btn"] = type,
...
function PageIndexInput(_a) {
    var pageIndex = _a.pageIndex, pageCount = _a.pageCount, onChange = _a.onChange;
    var _b = tslib_1.__read(react_1.useState(null), 2), inputValue = _b[0], setInputValue = _b[1];
    var t = i18n_1.useTranslation();
    return (react_1.default.createElement("div", { className: "tea-pagination__manualinput" },
        react_1.default.createElement("input", { type: "text", className: "tea-input tea-pagination__inputpagenum", value: inputValue === null ? String(pageIndex) : inputValue, onChange: function (evt) { return setInputValue(evt.target.value); }, onBlur: function () { return setInputValue(null); }, onKeyDown: function (evt) {
                // enter to confirm
                if (evt.keyCode === 13) {
        ...
        react_1.default.createElement("span", { className: "tea-pagination__totalpage" }, t.paginationPageCount(pageCount))));
}
