...
function CodeEditor(props) {
    ...
    var options = props.options, autoFocus = props.autoFocus, loadingPlaceholder = props.loadingPlaceholder, className = props.className, style = props.style, onEdit = props.onEdit, onReady = props.onReady, onSave = props.onSave;
    ...
    react_1.useEffect(function () {
        ...
        var receive = function (evt) {
            ...
            var send = function (type, payload) {
                evt.source.postMessage(encodeMessage(type, payload), "https://imgcache.qq.com");
            };
    ...
    return (react_1.default.createElement("div", { className: classnames_1.default("tea-code-editor", className), style: merge_style_1.mergeStyle({ position: "relative" }, style) },
        react_1.default.createElement("iframe", { title: "code-editor", ref: iframeRef, src: "https://imgcache.qq.com/qcloud/vendors/monaco-editor/frame/editor.html", className: "tea-code-editor-frame", style: { width: "100%", height: "100%" }, frameBorder: "no" }),
