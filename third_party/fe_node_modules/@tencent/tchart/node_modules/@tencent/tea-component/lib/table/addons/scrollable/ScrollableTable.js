...
function ScrollableTable(_a) {
    ...
    // 当前滚动区域是否在滚动状态
    var _c = tslib_1.__read(react_1.useState(), 2), bodyHasScroll = _c[0], setBodyHasScroll = _c[1];
    // 滚动区域的 DOM 引用
    ...
    function handleBodyScroll(event) {
        ...
        if (bodyHasScroll && scrollHeight - scrollTop <= clientHeight) {
    ...
    return (react_1.default.createElement(ScrollContext.Provider, { value: scrollContext }, react_1.default.cloneElement(table, tslib_1.__assign({}, props, { 
        // 设计通过提供 tea-table--scrollable 类来开启滚动区域的 overflow: auto
        className: classnames_1.default(table.props.className, "tea-table--scrollable") }))));
}
...
exports.ScrollableTableBody = react_1.forwardRef(function (_a, ref) {
    var body = _a.body, style = _a.style, props = tslib_1.__rest(_a, ["body", "style"]);
    var _b = react_1.useContext(ScrollContext), setBodyRef = _b.setBodyRef, onScrollCapture = _b.onScrollCapture;
    return react_1.default.cloneElement(body, tslib_1.__assign({}, props, { 
        // 使用 mergeRefs 可以使得其他插件的 ref 也能被调用到
        ref: merge_refs_1.mergeRefs(setBodyRef, body.ref, ref), style: merge_style_1.mergeStyle(body.props.style, style), onScrollCapture: call_both_1.callBoth(body.props.onScrollCapture, onScrollCapture) }));
});
/**
 * 包装表格头部，通过滚动状态调整右侧间距
 */
exports.ScrollableTableHead = react_1.forwardRef(function (_a, ref) {
    ...
    return react_1.default.cloneElement(head, tslib_1.__assign({}, props, { ref: merge_refs_1.mergeRefs(head.ref, ref), style: merge_style_1.mergeStyle(head.props.style, {
