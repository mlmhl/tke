...
var ValueSelect = /** @class */ (function (_super) {
    ...
    ValueSelect.prototype.render = function () {
        ...
        var _c = this.props, type = _c.type, inputValue = _c.inputValue, onChange = _c.onChange, onSelect = _c.onSelect, onCancel = _c.onCancel, offset = _c.offset;
        var props = { values: values, inputValue: inputValue, onChange: onChange, onSelect: onSelect, onCancel: onCancel, offset: offset };
