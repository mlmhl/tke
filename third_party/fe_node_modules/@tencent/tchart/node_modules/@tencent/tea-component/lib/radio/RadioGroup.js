...
function RadioGroup(props) {
    ...
    var context = {
        inject: function (checkProps) {
            ...
            return tslib_1.__assign({}, checkProps, { value: value === checkProps.name, disabled: checkProps.disabled || disabled, display: layout === "column" ? "block" : "inline", onChange: function (checked, context) {
