...
function Select(props) {
    ...
    var _b = form_1.useDefaultValue(props, null), value = _b.value, onChange = _b.onChange, _c = _b.options, _options = _c === void 0 ? [] : _c, _d = _b.groups, groups = _d === void 0 ? {} : _d, _e = _b.placeholder, placeholder = _e === void 0 ? t.pleaseSelect : _e, disabled = _b.disabled, button = _b.button, size = _b.size, type = _b.type, onScrollBottom = _b.onScrollBottom, className = _b.className, style = _b.style, boxSizeSync = _b.boxSizeSync, boxClassName = _b.boxClassName, _f = _b.boxStyle, boxStyle = _f === void 0 ? {} : _f, _g = _b.onOpen, onOpen = _g === void 0 ? noop : _g, _h = _b.onClose, onClose = _h === void 0 ? noop : _h, searchable = _b.searchable, _j = _b.onSearch, onSearch = _j === void 0 ? noop : _j, _k = _b.filter, filter = _k === void 0 ? function (inputValue, _a) {
        var text = _a.text, value = _a.value;
        var optionText = String(typeof text === "string" ? text : value);
        return !searchable || optionText.includes(inputValue);
    } : _k, dropdownProps = tslib_1.__rest(_b, ["value", "onChange", "options", "groups", "placeholder", "disabled", "button", "size", "type", "onScrollBottom", "className", "style", "boxSizeSync", "boxClassName", "boxStyle", "onOpen", "onClose", "searchable", "onSearch", "filter"]);
    ...
    var selected = value != null && options.find(function (x) { return x.value === value; });
    ...
    if (type === "simulate") {
        ...
        return (react_1.default.createElement(dropdown_1.Dropdown, tslib_1.__assign({ updateOnChildrenChange: true, ref: dropdownRef, clickClose: false, style: style, className: className, boxStyle: boxStyle, boxClassName: boxClassName, size: size, disabled: disabled, button: typeof button !== "undefined" ? button : buttonText, onOpen: function () {
                onOpen();
                focus();
            }, onClose: onClose }, dropdownProps), function (close) { return (react_1.default.createElement(react_1.default.Fragment, null,
    ...
    return (react_1.default.createElement("select", { className: classnames_1.default("tea-select", className, (_a = {},
        ...
        typeof placeholder === "string" && (react_1.default.createElement("option", { disabled: !!value }, placeholder)),
