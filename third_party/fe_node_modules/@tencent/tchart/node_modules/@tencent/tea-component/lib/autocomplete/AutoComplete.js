...
function AutoComplete(props) {
    var _a = form_1.useDefaultValue(props), className = _a.className, _b = _a.style, style = _b === void 0 ? {} : _b, value = _a.value, onChange = _a.onChange, children = _a.children, _c = _a.options, options = _c === void 0 ? [] : _c, _d = _a.groups, groups = _d === void 0 ? {} : _d, _e = _a.tips, tips = _e === void 0 ? "" : _e, keyword = _a.keyword, onScrollBottom = _a.onScrollBottom;
    var inputRef = react_1.useRef(null);
    var _f = tslib_1.__read(react_1.useState(false), 2), isOpened = _f[0], setIsOpened = _f[1];
    var _g = tslib_1.__read(react_1.useState(undefined), 2), dropdownWidth = _g[0], setDropdownWidth = _g[1];
    var close = function () { return setIsOpened(false); };
    var hasGroup = !!options.find(function (opt) { return !!opt.groupKey; });
    return (react_1.default.createElement(popover_1.Popover, { animationScaleFrom: 1, transitionTimeout: { enter: 0, exit: 100 }, trigger: AutoCompleteTrigger, placement: "bottom-start", visible: isOpened, onVisibleChange: setIsOpened, placementOffset: 5, overlay: react_1.default.createElement(dropdown_1.DropdownBox, { className: className, style: tslib_1.__assign({ width: dropdownWidth }, style) }, Array.isArray(options) && options.length > 0 ? (react_1.default.createElement(list_1.List, { type: hasGroup ? "option-group" : "option", onScrollBottom: onScrollBottom }, options.map(function (_a, index) {
