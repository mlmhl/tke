...
function radioable(_a) {
    ...
    return {
        ...
        onInjectRow: function (renderRow) { return function (record, rowKey, recordIndex, columns) {
            ...
            var row = preRow;
            // 支持整行选择
            row = (react_1.default.createElement(SelectWrapper, { key: rowKey, name: rowKey, value: value, onChange: function (value, context) { return onChange(value, tslib_1.__assign({}, context, { record: record })); }, rowSelect: rowSelect && !rowDisabled(record) }, row));
