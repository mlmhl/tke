...
var MultipleValueSelect = /** @class */ (function (_super) {
    ...
    MultipleValueSelect.prototype.render = function () {
        ...
        var _b = this.props, t = _b.t, values = _b.values, offset = _b.offset, _c = _b.all, all = _c === void 0 ? true : _c;
        var list = values.map(function (item, index) { return (react_1.default.createElement(list_1.List.Item, { key: index, current: curIndex === index + 1, onClick: function (e) { return _this.handleClick(e, index); } },
            react_1.default.createElement("label", { className: "tea-form-check", style: item.style || {}, title: item.name },
                react_1.default.createElement("input", { type: "checkbox", readOnly: true, checked: select.indexOf(index) >= 0, className: "tea-checkbox" }),
                react_1.default.createElement("span", { className: "tea-form-check__label" }, item.name)))); });
        if (list.length === 0)
            return null;
        var maxHeight = document.body.clientHeight
            ? document.body.clientHeight - 400
            : 450;
        maxHeight = maxHeight > 242 ? maxHeight : 242;
        return (react_1.default.createElement(dropdown_1.DropdownBox, { style: { left: offset }, onClick: function (e) { return e.stopPropagation(); } },
            react_1.default.createElement(list_1.List, { type: "option", style: { maxHeight: maxHeight } },
                !!all && (react_1.default.createElement(list_1.List.Item, { onClick: this.handleSelectAll, current: curIndex === 0 },
                    react_1.default.createElement("label", { className: "tea-form-check" },
                        react_1.default.createElement("input", { type: "checkbox", readOnly: true, className: "tea-checkbox", checked: select.length === values.length }),
                        react_1.default.createElement("span", { className: "tea-form-check__label" }, t.selectAllText)))),
                list),
