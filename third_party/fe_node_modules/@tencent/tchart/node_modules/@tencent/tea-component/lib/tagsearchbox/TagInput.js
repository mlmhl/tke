        ...
        return (react_1.default.createElement(overlay_1.Overlay, { layers: [
                react_1.default.createElement(overlay_1.Overlay.Layer, { key: "edit", placementOffset: type === "edit" ? 12 : 2, transitionTimeout: { enter: 50, exit: 0 }, overlayProps: {
                        ...
                        return (react_1.default.createElement(react_1.default.Fragment, null,
                            showAttrSelect && (react_1.default.createElement(AttributeSelect_1.AttributeSelect, { ref: function (select) { return (_this["attr-select"] = select); }, attributes: attributes, inputValue: attrStr, onSelect: _this.handleAttrSelect })),
                            showValueSelect && !!attribute && !!attribute.type && (react_1.default.createElement(ValueSelect_1.ValueSelect, { type: attribute.type, ref: function (select) { return (_this["value-select"] = select); }, values: attribute.values, inputValue: valueStr.trim(), offset: ValueSelectOffset, onChange: _this.handleValueChange, onSelect: _this.handleValueSelect, onCancel: _this.handleValueCancel }))));
                    } }),
            ] }, function (ref) { return (react_1.default.createElement("div", { ref: ref, style: {
