...
function DateTable(_a) {
    ...
    function renderYear() {
        return (react_1.default.createElement("a", { href: "javascript:;", className: "op-item", onClick: function () { return onTypeChange("year"); } }, current.format(t.yearFormat)));
    }
    function renderMonth() {
        return (react_1.default.createElement("a", { href: "javascript:;", className: "op-item", onClick: function () { return onTypeChange("month"); } }, moment_1.default.monthsShort(month)));
    }
