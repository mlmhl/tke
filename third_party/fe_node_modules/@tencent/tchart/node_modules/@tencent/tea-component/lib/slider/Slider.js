...
function Slider(_a) {
    ...
    var _j = tslib_1.__read(react_1.useState(value), 2), current = _j[0], setCurrent = _j[1];
    react_1.useEffect(function () {
        setCurrent(value);
    }, [value]);
    var range = Math.abs(max - min);
    var proportion = ((current - min) / range) * 100;
    // 定位相关 hooks
    ...
    return (react_1.default.createElement("div", { className: classnames_1.default("tea-slider", className, {
        ...
        react_1.default.createElement(popover_1.Popover, { visible: enableTrackTip &&
                ...
                return (react_1.default.createElement(bubble_1.BubbleContent, { placement: placement }, tipFormatter(getValueByPosition(mousePosition))));
            } },
            react_1.default.createElement("div", { className: "tea-slider__content", onMouseDown: handleMouseDownOnBar, onMouseMove: handleMouseMoveForPopover, onMouseLeave: function () { return setMousePosition(null); }, onDragStart: function (e) { return e.preventDefault(); } },
                react_1.default.createElement(StartFlag, { ref: startRef }),
                react_1.default.createElement("div", { className: "tea-slider__bar" },
                    react_1.default.createElement("div", { className: "tea-slider__track", style: { width: proportion + "%" } })),
                react_1.default.createElement(popover_1.Popover, { visible: dragging || hovering, overlayStyle: {
                        ...
                        return (react_1.default.createElement(bubble_1.BubbleContent, { placement: placement }, tipFormatter(current)));
                    } },
                    react_1.default.createElement("div", { className: "tea-slider__handle", style: { left: proportion + "%" }, onMouseDown: handleMouseDown, onMouseEnter: function () { return setHovering(true); }, onMouseLeave: function () { return setHovering(false); }, onClick: function (e) { return e.stopPropagation(); }, onMouseMove: function (e) { return e.stopPropagation(); } },
                        react_1.default.createElement("span", { className: "tea-slider__handle-inner" }))),
                react_1.default.createElement("div", { className: "tea-slider__mark" }, marks
                    .filter(function (_a) {
                    var value = _a.value;
                    ...
                    return (react_1.default.createElement("span", { key: value, className: "tea-slider__text", style: {
                            left: ((value - min) / range) * 100 + "%",
                            userSelect: "none",
                        } }, label || value));
                })),
                react_1.default.createElement(EndFlag, { ref: endRef }))),
        react_1.default.createElement("div", { className: "tea-slider__extend" }, after)));
}
