...
class ChartInstancesPanel extends react__WEBPACK_IMPORTED_MODULE_0__["Component"] {
    ...
    fetchDataByTables(options = {}) {
        ...
        // 初始状态
        this.setState({ seriesGroup: this.getEmptyData(), instanceList: this.props.instance.list, loading: true });
    ...
    requestData(tableInfo = {}) {
        ...
        // 查询的时间粒度
        const period = Object(_helper__WEBPACK_IMPORTED_MODULE_6__["Period"])(startTime, endTime);
        return _core__WEBPACK_IMPORTED_MODULE_5__["CHART_PANEL"].RequestData({
            ...
            Object.keys(dimensionsData).forEach(groupByKey => {
                ...
                if (!this._instances[groupByKey]) {
                    ...
                    instance["isChecked"] = this.props.instance && this.props.instance.list.length > 0 ? false : true;
    ...
    render() {
        const { loading, seriesGroup, instanceList, startTime, endTime } = this.state;
        return (react__WEBPACK_IMPORTED_MODULE_0__["createElement"]("div", { className: "tc-15-rich-dialog-bd" },
            react__WEBPACK_IMPORTED_MODULE_0__["createElement"](_components_Toolbar__WEBPACK_IMPORTED_MODULE_1__["Toolbar"], { duration: { from: this.state.startTime, to: this.state.endTime }, onChangeTime: this.onChangeQueryTime.bind(this) }, this.props.children),
                ...
                react__WEBPACK_IMPORTED_MODULE_0__["createElement"]("div", { className: "tc-g" },
                    react__WEBPACK_IMPORTED_MODULE_0__["createElement"]("div", { className: "tc-g-u-3-4" },
                        react__WEBPACK_IMPORTED_MODULE_0__["createElement"](_components_MetricCharts__WEBPACK_IMPORTED_MODULE_2__["default"], { className: "monitor-chart-grid", style: {
                            ...
                            }, loading: loading, min: typeof startTime === "string" ? 0 : startTime.getTime(), max: typeof endTime === "string" ? 0 : endTime.getTime(), seriesGroup: seriesGroup, reload: this.fetchDataByTables.bind(this, { instances: this.state.instanceList }) })),
