...
exports.Check = react_1.forwardRef(function (_props, ref) {
    ...
    var _a = controlled_1.useDefaultValue(props, false), value = _a.value, onChange = _a.onChange, type = _a.type, indeterminate = _a.indeterminate, children = _a.children, className = _a.className, _b = _a.disabled, disabled = _b === void 0 ? false : _b, onClick = _a.onClick, display = _a.display, style = _a.style, inputRef = _a.inputRef, tooltip = _a.tooltip, tabIndex = _a.tabIndex, htmlProps = tslib_1.__rest(_a, ["value", "onChange", "type", "indeterminate", "children", "className", "disabled", "onClick", "display", "style", "inputRef", "tooltip", "tabIndex"]);
    ...
    var check = (react_1.default.createElement("label", tslib_1.__assign({ ref: ref, className: labelClassName, style: style }, htmlProps, { onClick: function (event) { return event.stopPropagation(); } }),
        react_1.default.createElement("input", { readOnly: true, ref: forwardInputRef, type: type, className: "tea-" + type, checked: value, disabled: disabled, tabIndex: tabIndex, onClick: call_both_1.callBoth(onClick, function (event) {
