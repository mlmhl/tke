...
function selectable(options) {
    var _a = options.relations, relations = _a === void 0 ? {} : _a, value = options.value, onChange = options.onChange, all = options.all, targetColumnKey = options.targetColumnKey, indent = options.indent, rowSelect = options.rowSelect, _b = options.width, width = _b === void 0 ? 26 : _b, _c = options.render, render = _c === void 0 ? function (x) { return x; } : _c, _d = options.shouldRecordExcludeFromAll, shouldRecordExcludeFromAll = _d === void 0 ? "disabled" : _d, _e = options.rowSelectable, rowSelectable = _e === void 0 ? function () { return true; } : _e;
    ...
    return {
        ...
        onInjectColumn: function (previous) { return function (record, rowKey, recordIndex, column) {
            ...
            if (recordIndex === -1) {
                if (all !== false) {
                    children = (react_1.default.createElement(checkbox_1.Checkbox, { name: allKey }, children || react_1.default.createElement(react_1.default.Fragment, null, "\u00A0")));
                }
            }
            // 记录行
            else {
                ...
                var checkbox = (react_1.default.createElement(checkbox_1.Checkbox, { className: "tea-form-check--table-select", name: rowKey }, children || react_1.default.createElement(react_1.default.Fragment, null, "\u00A0")));
