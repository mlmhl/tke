...
import { StatusTipProps } from "../../tips";
 ...
 */
export declare function autotip(options: AutoTipOptions): TableAddon;
export declare namespace autotip {
    var fromLegacyState: ({ enableLoading, fetcher, query, onClearSearch, onRetry, emptyTips, }: LegacySmartTipState) => TableAddon<any>;
}
