...
function DropdownBox(_a) {
    var className = _a.className, _b = _a.style, style = _b === void 0 ? {} : _b, children = _a.children, onClick = _a.onClick, _c = _a.onUpdate, onUpdate = _c === void 0 ? noop : _c;
...
exports.Dropdown = forward_ref_with_statics_1.forwardRefWithStatics(function (props, ref) {
    ...
    return (react_1.default.createElement(popover_1.Popover, { trigger: disabled
            ...
            return (react_1.default.createElement(DropdownBox, { className: boxClassName, style: boxStyle, onClick: clickClose ? close : null, onUpdate: updateOnChildrenChange ? scheduleUpdate : undefined }, boxChildren));
        } },
