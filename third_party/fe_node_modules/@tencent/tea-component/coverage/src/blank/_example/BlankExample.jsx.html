...
<html lang="en">
<head>
    <title>Code coverage report for src/blank/_example/BlankExample.jsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">All files</a> / <a href="index.html">src/blank/_example</a> BlankExample.jsx
    </h1>
    <div class='clearfix'>
      ...
      &lt;Body&gt;
        &lt;Content&gt;
          &lt;Content.Header title="场景切换"&gt;
            &lt;Radio.Group
              value={theme}
              onChange={<span class="fstat-no" title="function not covered" >va</span>lue =&gt; <span class="cstat-no" title="statement not covered" >setTheme(value)}</span>
              layout="inline"
            &gt;
