...
<html lang="en">
<head>
    <title>Code coverage report for src/table/Table.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/table</a> Table.tsx
    </h1>
    <div class='clearfix'>
...
&nbsp;
    ...
    function <span class="fstat-no" title="function not covered" >handleScroll(</span>) {
<span class="cstat-no" title="statement not covered" >      if (headRef.current &amp;&amp; bodyRef.current) {</span>
<span class="cstat-no" title="statement not covered" >        headRef.current.scrollLeft = bodyRef.current.scrollLeft;</span>
      }
    }
&nbsp;
