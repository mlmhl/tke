...
<html lang="en">
<head>
    <title>Code coverage report for src/table/addons/filterable/filterable.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../../index.html">All files</a> / <a href="index.html">src/table/addons/filterable</a> filterable.tsx
    </h1>
    <div class='clearfix'>
...
&nbsp;
      ...
      } else <span class="missing-if-branch" title="else path not taken" >E</span>if (config.type === "multiple") {
        children = (
