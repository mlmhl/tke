...
<html lang="en">
<head>
    <title>Code coverage report for src/table/addons/radioable.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">All files</a> / <a href="index.html">src/table/addons</a> radioable.tsx
    </h1>
    <div class='clearfix'>
...
export function radioable({
  ...
  rowSelect,
  width = 26,
  render = <span class="fstat-no" title="function not covered" ><span class="branch-0 cbranch-no" title="branch not covered" >x </span>=&gt; <span class="cstat-no" title="statement not covered" >x,</span></span>
}: RadioableOptions): TableAddon {
  return {
    onInjectProps: props =&gt; {
      rowDisabled = props.rowDisabled || (<span class="fstat-no" title="function not covered" ><span class="branch-1 cbranch-no" title="branch not covered" >()</span> =&gt; <span class="cstat-no" title="statement not covered" >false)</span></span>;
&nbsp;
      ...
      if (recordIndex !== -1) {
        const element = (
          &lt;Radio
            ...
            value={value === rowKey}
            onChange={<span class="fstat-no" title="function not covered" >(_</span>, { event }) =&gt; <span class="cstat-no" title="statement not covered" >onChange(rowKey, { event, record })}</span>
          &gt;
            {children || &lt;&gt;&amp;nbsp;&lt;/&gt;}
          &lt;/Radio&gt;
        );
    ...
    onInjectRow: renderRow =&gt; (record, rowKey, recordIndex, columns) =&gt; {
      ...
      row = (
        &lt;SelectWrapper
          ...
          name={rowKey}
          value={value}
          onChange={<span class="fstat-no" title="function not covered" >(v</span>alue, context) =&gt; <span class="cstat-no" title="statement not covered" >onChange(value, { ...context, record })}</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >      return onChange(name, { event });</span>
    },
  };
&nbsp;
  return React.cloneElement(children, {
    ...
    ...(rowSelect ? rowSelectProps : <span class="branch-1 cbranch-no" title="branch not covered" >{})</span>,
  });
}
&nbsp;</pre></td></tr>
</table></pre>
