...
<html lang="en">
<head>
    <title>Code coverage report for src/table/addons/indentable.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">All files</a> / <a href="index.html">src/table/addons</a> indentable.tsx
    </h1>
    <div class='clearfix'>
...
&nbsp;
      ...
      if (recordIndex !== -1) {
        let paddingLeft = 0;
        let depth = 0;
        <span class="missing-if-branch" title="else path not taken" >E</span>if (indent &gt; 0) {
          let node = rowKey;
