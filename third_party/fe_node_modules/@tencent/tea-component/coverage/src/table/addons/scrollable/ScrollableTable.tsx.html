...
<html lang="en">
<head>
    <title>Code coverage report for src/table/addons/scrollable/ScrollableTable.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../../index.html">All files</a> / <a href="index.html">src/table/addons/scrollable</a> ScrollableTable.tsx
    </h1>
    <div class='clearfix'>
...
export function ScrollableTable({
  table,
  scrollHeightFactor,
  onScrollBottom = <span class="fstat-no" title="function not covered" ><span class="branch-0 cbranch-no" title="branch not covered" >()</span> =&gt; <span class="cstat-no" title="statement not covered" >null,</span></span>
  ...props
...
&nbsp;
  ...
  useEffect(() =&gt; {
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (bodyBox) {
...
&nbsp;
  function <span class="fstat-no" title="function not covered" >handleBodyScroll(</span>event: React.UIEvent&lt;HTMLElement&gt;) {
    const bodyBox = <span class="cstat-no" title="statement not covered" >event.target as HTMLElement;</span>
    const { scrollHeight, scrollTop, clientHeight } = <span class="cstat-no" title="statement not covered" >bodyBox;</span>
<span class="cstat-no" title="statement not covered" >    if (bodyHasScroll &amp;&amp; scrollHeight &lt;= Math.round(clientHeight + scrollTop)) {</span>
...
export const ScrollableTableBody = forwardRef(
  (
    ...
    const bodyRef = useRef&lt;HTMLDivElement&gt;(null);
    useEffect(() =&gt; {
      <span class="missing-if-branch" title="if path not taken" >I</span>if (scrollToTopOnChange &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >bodyRef.current)</span> {
<span class="cstat-no" title="statement not covered" >        bodyRef.current.scrollTo(0, 0);</span>
      }
  ...
  (
    ...
    return React.cloneElement(head, {
      ...
      style: mergeStyle(head.props.style, {
        marginRight: bodyHasScroll ? <span class="branch-0 cbranch-no" title="branch not covered" >getScrollBarSize() </span>: null,
      }),
    });
  }
);
