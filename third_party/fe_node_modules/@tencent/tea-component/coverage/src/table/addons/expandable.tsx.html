...
<html lang="en">
<head>
    <title>Code coverage report for src/table/addons/expandable.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">All files</a> / <a href="index.html">src/table/addons</a> expandable.tsx
    </h1>
    <div class='clearfix'>
...
&nbsp;
  const expandedKeySet = new Set(expandedKeys || <span class="branch-1 cbranch-no" title="branch not covered" >[])</span>;
&nbsp;
...
&nbsp;
      ...
      if (recordIndex !== -1) {
        ...
        if (isExpandable) {
          const toggle = <span class="fstat-no" title="function not covered" >(e</span>vent: React.MouseEvent) =&gt; {
<span class="cstat-no" title="statement not covered" >            if (isExpanded) {</span>
              const nextSet = <span class="cstat-no" title="statement not covered" >new Set(expandedKeySet);</span>
<span class="cstat-no" title="statement not covered" >              nextSet.delete(key);</span>
<span class="cstat-no" title="statement not covered" >              onExpandedKeysChange(Array.from(nextSet.keys()), {</span>
...
<span class="cstat-no" title="statement not covered" >              onExpandedKeysChange(expandedKeys.concat(key), {</span>
                operateType: "expand",
                operateKey: key,
                operateRecord: record,
                event,
...
&nbsp;
      ...
      <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof render === "function") {
<span class="cstat-no" title="statement not covered" >        expands.push(</span>
      ...
      // 更多的数据走原来表格的渲染逻辑
      else <span class="missing-if-branch" title="else path not taken" >E</span>if (typeof expand === "function") {
        // 展开的数据
        const expandedRecords = expand(record) || <span class="branch-1 cbranch-no" title="branch not covered" >[];</span>
&nbsp;
        // 展开数据的渲染和追加
...
&nbsp;
function IconWrap({ onClick, children }) {
  const { classPrefix } = useConfig();
  return (
    &lt;a className={`${classPrefix}-table__icon-wrap`} onClick={onClick}&gt;
      {children}
    &lt;/a&gt;
  );
}
