...
<html lang="en">
<head>
    <title>Code coverage report for src/table/addons/selectable.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">All files</a> / <a href="index.html">src/table/addons</a> selectable.tsx
    </h1>
    <div class='clearfix'>
...
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof indent !== "undefined") {
...
&nbsp;
  ...
  const allKey = typeof all === "string" ? <span class="branch-0 cbranch-no" title="branch not covered" >all </span>: fallbackAllKey;
&nbsp;
...
&nbsp;
      ...
      // 记录行
        ...
        let paddingLeft = 0;
        let depth = 0;
        <span class="missing-if-branch" title="if path not taken" >I</span>if (indent &gt; 0) {
          let node = <span class="cstat-no" title="statement not covered" >rowKey;</span>
<span class="cstat-no" title="statement not covered" >          while (relations &amp;&amp; relations[node]) {</span>
<span class="cstat-no" title="statement not covered" >            depth += 1;</span>
<span class="cstat-no" title="statement not covered" >            node = relations[node];</span>
          }
<span class="cstat-no" title="statement not covered" >          paddingLeft = indent * depth;</span>
        }
&nbsp;
        const checkbox = (
...
<span class="branch-0 cbranch-no" title="branch not covered" >          &lt;div style={{ paddingLeft }}&gt;{checkbox}&lt;/div&gt;</span>
        ) : (
          checkbox
        );
&nbsp;
...
&nbsp;
      ...
      <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof shouldRecordExcludeFromAll === "function") {
<span class="cstat-no" title="statement not covered" >        shouldRecordExcludeFromAllFinal = shouldRecordExcludeFromAll;</span>
      } else <span class="missing-if-branch" title="else path not taken" >E</span>if (shouldRecordExcludeFromAll === "disabled") {
        shouldRecordExcludeFromAllFinal = rowDisabled;
      }
      shouldRecordExcludeFromAllFinal =
        shouldRecordExcludeFromAllFinal || (<span class="fstat-no" title="function not covered" ><span class="branch-1 cbranch-no" title="branch not covered" >()</span> =&gt; <span class="cstat-no" title="statement not covered" >false)</span></span>;
&nbsp;
...
&nbsp;
      ...
      const rootKeys = relations ? keys.filter(key =&gt; !relations[key]) : <span class="branch-1 cbranch-no" title="branch not covered" >keys;</span>
&nbsp;
      const relationWithLeafs = {
        ...(relations || <span class="branch-1 cbranch-no" title="branch not covered" >{})</span>,
      };
&nbsp;
...
&nbsp;
      return (
        &lt;CheckTree
          ...
          onChange={
            hasRelations
              ? <span class="fstat-no" title="function not covered" >(v</span>alue, context) =&gt;
<span class="cstat-no" title="statement not covered" >                  onChange(value, {</span>
                    ...context,
                    record: records.find(
<span class="fstat-no" title="function not covered" >                      (r</span>ecord, index) =&gt;
<span class="cstat-no" title="statement not covered" >                        context.check.name === rowKey(record, index)</span>
                    ),
                    selectedRecords: records.filter(<span class="fstat-no" title="function not covered" >(r</span>ecord, index) =&gt;
<span class="cstat-no" title="statement not covered" >                      value.includes(rowKey(record, index))</span>
                    ),
                  })
...
function SelectWrapper({
  ...
  <span class="missing-if-branch" title="else path not taken" >E</span>if (context) {
    const checkProps = context.inject({ type: "checkbox", name });
    const { onChange, value } = checkProps;
&nbsp;
    const rowSelectProps = {
      onClick: <span class="fstat-no" title="function not covered" >(e</span>vent: React.MouseEvent&lt;HTMLTableRowElement&gt;) =&gt; {
        // 事件合并
<span class="cstat-no" title="statement not covered" >        if (typeof props.onClick === "function") {</span>
<span class="cstat-no" title="statement not covered" >          props.onClick(event);</span>
        }
<span class="cstat-no" title="statement not covered" >        if (typeof children.props.onClick === "function") {</span>
<span class="cstat-no" title="statement not covered" >          children.props.onClick(event);</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        return onChange(!value, { event, check: checkProps });</span>
      },
    };
&nbsp;
