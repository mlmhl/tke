...
<html lang="en">
<head>
    <title>Code coverage report for src/table/_example/TableComplexExample.jsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">All files</a> / <a href="index.html">src/table/_example</a> TableComplexExample.jsx
    </h1>
    <div class='clearfix'>
...
<a name='L499'></a><a href='#L499'>499</a></td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import React, { useState, useMemo, useCallback } from "react";
    ...
    &lt;Table
      ...
      addons={[
        expandable({
          ...
          expandedKeys,
          // 产品展开为消息行
          expand: record =&gt; record.msgList || <span class="branch-1 cbranch-no" title="branch not covered" >null,</span>
          // 发生展开行为时，回调更新展开键值
          onExpandedKeysChange: <span class="fstat-no" title="function not covered" >ke</span>ys =&gt; <span class="cstat-no" title="statement not covered" >setExpandedKeys(keys),</span>
          // 只有产品行允许展开
        ...
        selectable({
          ...
          value: selectedKeys,
          // 选中键值发生变更
          onChange: <span class="fstat-no" title="function not covered" >va</span>lue =&gt; <span class="cstat-no" title="statement not covered" >setSelectedKeys(value),</span>
        }),
        indentable({
          // 缩进放在「消息类型」列上
          targetColumnKey: "name",
...
<span class="cstat-no" title="statement not covered" >            if (expandedSet.has(type)) {</span>
<span class="cstat-no" title="statement not covered" >              expandedSet.delete(type);</span>
            } else {
<span class="cstat-no" title="statement not covered" >              expandedSet.add(type);</span>
            }
<span class="cstat-no" title="statement not covered" >            setExpandedKeys(Array.from(expandedSet));</span>
          }}
        &gt;
          &lt;strong&gt;{text}&lt;/strong&gt;
        &lt;/Button&gt;
