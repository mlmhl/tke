...
<html lang="en">
<head>
    <title>Code coverage report for src/table/TableHead.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/table</a> TableHead.tsx
    </h1>
    <div class='clearfix'>
...
export const TableHead = forwardRef(function TableHead(
  ...
  const { columns, addons, boxStyle, disableTextOverflow } = props;
&nbsp;
...
&nbsp;
      ...
      <span class="missing-if-branch" title="if path not taken" >I</span>if (isCallable(header)) {
<span class="cstat-no" title="statement not covered" >        children = header(column);</span>
      }
&nbsp;
      // forgot to pass, use a key as a reminder
      <span class="missing-if-branch" title="if path not taken" >I</span>if (header === undefined) {
<span class="cstat-no" title="statement not covered" >        children = key;</span>
      }
&nbsp;
      // plain values
      if (typeof header === "string" || typeof header === "number") {
        children = (
          &lt;Text
            ...
            title={disableTextOverflow ? <span class="branch-0 cbranch-no" title="branch not covered" >undefined </span>: String(header)}
          &gt;
            {header}
          &lt;/Text&gt;
        );
...
&nbsp;
  const tableHeaders = columns.map((column, index) =&gt; {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (props.colSpan === 0) {
