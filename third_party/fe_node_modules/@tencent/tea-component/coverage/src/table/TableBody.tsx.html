...
<html lang="en">
<head>
    <title>Code coverage report for src/table/TableBody.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/table</a> TableBody.tsx
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import React, { forwardRef, Fragment } from "react";
...
export const TableBody = forwardRef(function TableBody(
  {
    ...
    disableTextOverflow,
    onScrollCapture = <span class="fstat-no" title="function not covered" ><span class="branch-0 cbranch-no" title="branch not covered" >()</span> =&gt; <span class="cstat-no" title="statement not covered" >null,</span></span>
  }: TableProps &amp; {
...
&nbsp;
  ...
  const renderColumn = useMiddleware(addons, "onInjectColumn")(
    (record, rowKey, recordIndex, column, columnIndex) =&gt; {
      ...
      } else <span class="missing-if-branch" title="else path not taken" >E</span>if (typeof record === "object" &amp;&amp; record) {
        children = record[column.key];
      }
      <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof children === "undefined") {
      ...
      if (typeof children !== "object") {
        children = (
          &lt;Text
            ...
            title={disableTextOverflow ? <span class="branch-0 cbranch-no" title="branch not covered" >undefined </span>: String(children)}
          &gt;
            {children}
          &lt;/Text&gt;
        );
        ...
        row: (
          &lt;tr key={rowKey} className={className || null}&gt;
            {columns.map((column, index) =&gt; {
              ...
              <span class="missing-if-branch" title="if path not taken" >I</span>if (props.colSpan === 0 || props.rowSpan === 0) {
...
&nbsp;
  const renderBody = useMiddleware(addons, "onInjectBody")(
    (records, columns, topTip, bottomTip) =&gt; (
      ...
      &gt;
        &lt;TableBox columns={columns} style={boxStyle} classPrefix={classPrefix}&gt;
          &lt;tbody&gt;
            &lt;SlideTransition in={Boolean(topTip)} exit={false}&gt;
              ...
              &lt;/tr&gt;
            &lt;/SlideTransition&gt;
            {(records || <span class="branch-1 cbranch-no" title="branch not covered" >[])</span>.map((record, index) =&gt; (
