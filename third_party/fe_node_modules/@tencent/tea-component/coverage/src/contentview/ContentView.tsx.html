...
<html lang="en">
<head>
    <title>Code coverage report for src/contentview/ContentView.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/contentview</a> ContentView.tsx
    </h1>
    <div class='clearfix'>
...
export function ContentViewHeader({
  showBackButton,
  onBackButtonClick = <span class="fstat-no" title="function not covered" ><span class="branch-0 cbranch-no" title="branch not covered" >()</span> =&gt; <span class="cstat-no" title="statement not covered" >null,</span></span>
  title,
  subtitle,
  operation,
  children,
...
function ContentViewBody({
  ...
  return (
    ...
    &gt;
      ...
      &gt;
        {sidebar &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >&lt;div className={`${classPrefix}-sidebar`}&gt;{sidebar}&lt;/div&gt;}</span>
        {children}
      &lt;/div&gt;
    &lt;/div&gt;
  );
