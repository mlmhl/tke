...
<html lang="en">
<head>
    <title>Code coverage report for src/navmenu/NavMenu.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/navmenu</a> NavMenu.tsx
    </h1>
    <div class='clearfix'>
...
&nbsp;
  // default
  <span class="missing-if-branch" title="else path not taken" >E</span>if (typeof children === "string") {
    return (
      &lt;div {...wrapperProps}&gt;
        &lt;a&gt;{children}&lt;/a&gt;
      &lt;/div&gt;
...
<span class="cstat-no" title="statement not covered" >  return &lt;div {...wrapperProps}&gt;{children}&lt;/div&gt;;</span>
}
&nbsp;
