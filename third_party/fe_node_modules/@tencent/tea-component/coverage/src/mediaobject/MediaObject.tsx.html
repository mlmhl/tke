...
<html lang="en">
<head>
    <title>Code coverage report for src/mediaobject/MediaObject.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/mediaobject</a> MediaObject.tsx
    </h1>
    <div class='clearfix'>
...
export function MediaObject({
  align = <span class="branch-0 cbranch-no" title="branch not covered" >"top",</span>
  reverse,
  media,
  children,
}: MediaObjectProps) {
