...
<html lang="en">
<head>
    <title>Code coverage report for src/metricsboard/MetricsBoard.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/metricsboard</a> MetricsBoard.tsx
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import classNames from "classnames";
  ...
  (
    {
      ...
      value,
      unit,
      infos = <span class="branch-0 cbranch-no" title="branch not covered" >[],</span>
      onClick,
      className,
      style,
    }: MetricsBoardProps,
    ...
    return (
      &lt;div
        ...
        style={style}
        onClick={hasOnClick ? onClick : <span class="fstat-no" title="function not covered" >()</span> =&gt; <span class="cstat-no" title="statement not covered" >null}</span>
        ref={ref}
      &gt;
