...
<html lang="en">
<head>
    <title>Code coverage report for src/check/Check.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/check</a> Check.tsx
    </h1>
    <div class='clearfix'>
...
&nbsp;
    const labelClassName = classNames(
      ...
      {
        [`${classPrefix}-form-check--block`]: display === "block",
      },
      className
    );
&nbsp;
...
&nbsp;
    let check = (
      ...
      &gt;
        {type === "radio" ? (
          &lt;span className={`${classPrefix}-radio-wrap`}&gt;
            {input}
            &lt;i className={`${classPrefix}-radio__dot`} /&gt;
          &lt;/span&gt;
        ) : (
          input
        )}
        &lt;span key="label" className={`${classPrefix}-form-check__label`}&gt;
          {children}
        &lt;/span&gt;
      &lt;/label&gt;
    );
