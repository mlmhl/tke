...
<html lang="en">
<head>
    <title>Code coverage report for src/tree/TreeNode.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/tree</a> TreeNode.tsx
    </h1>
    <div class='clearfix'>
  ...
  return (
    ...
    &gt;
      &lt;div
        ...
        onClick={<span class="fstat-no" title="function not covered" >()</span> =&gt; <span class="cstat-no" title="statement not covered" >activable &amp;&amp; onActive(id)}</span>
      &gt;
        &lt;TreeNodeSwitcher
          id={id}
          icon={switcherIcon}
...
function TreeNodeSwitcher({
  ...
  onExpand,
  onLoad,
  onLoadError = <span class="fstat-no" title="function not covered" >()</span> =&gt; <span class="cstat-no" title="statement not covered" >null,</span>
  icon = ({ expanded }) =&gt; (
...
&nbsp;
  async function <span class="fstat-no" title="function not covered" >handleExpand(</span>event: React.MouseEvent) {
...
<span class="cstat-no" title="statement not covered" >      onExpand(id, false);</span>
...
<span class="cstat-no" title="statement not covered" >        await onLoad(id);</span>
<span class="cstat-no" title="statement not covered" >        onExpand(id, true);</span>
      } catch (err) {
<span class="cstat-no" title="statement not covered" >        setError(true);</span>
<span class="cstat-no" title="statement not covered" >        onLoadError(id, err);</span>
      } finally {
...
<span class="branch-1 cbranch-no" title="branch not covered" >    &lt;div onClick={handleExpand}&gt;{switcherIcon}&lt;/div&gt;</span>
  );
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (loading) {
<span class="cstat-no" title="statement not covered" >    switcher = &lt;Icon type="loading" /&gt;;</span>
  }
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (error) {
<span class="cstat-no" title="statement not covered" >    switcher = &lt;Icon type="error" onClick={handleExpand} /&gt;;</span>
  }
&nbsp;
  return (
