...
<html lang="en">
<head>
    <title>Code coverage report for src/progress/Progress.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/progress</a> Progress.tsx
    </h1>
    <div class='clearfix'>
...
export function Progress({
  type = "line",
  percent = <span class="branch-0 cbranch-no" title="branch not covered" >0,</span>
  text,
  tips,
  theme = +percent === 100 ? <span class="branch-0 cbranch-no" title="branch not covered" >"success" </span>: "default",
  className,
  style,
}: ProgressProps) {
