...
<html lang="en">
<head>
    <title>Code coverage report for src/datepicker/util.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/datepicker</a> util.ts
    </h1>
    <div class='clearfix'>
...
&nbsp;
export function <span class="fstat-no" title="function not covered" >getYearMonthDate(</span>date: Moment) {
