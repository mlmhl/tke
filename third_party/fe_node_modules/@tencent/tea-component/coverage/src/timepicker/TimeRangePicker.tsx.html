...
<html lang="en">
<head>
    <title>Code coverage report for src/timepicker/TimeRangePicker.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/timepicker</a> TimeRangePicker.tsx
    </h1>
    <div class='clearfix'>
...
&nbsp;
    ...
    const getInputValue = useCallback(
      (value: RangeDateType): string =&gt; {
        const [start, end] = value || <span class="branch-1 cbranch-no" title="branch not covered" >[null, null];</span>
...
&nbsp;
    function <span class="fstat-no" title="function not covered" >handleChange(</span>
      ...
      const [start, end] = <span class="cstat-no" title="statement not covered" >value;</span>
      const fullValue: RangeDateType = <span class="cstat-no" title="statement not covered" >[</span>
        start || getDefaultMoment(range, disabledTime(value, "start")),
        end || getDefaultMoment(range, disabledTime(value, "end")),
      ];
<span class="cstat-no" title="statement not covered" >      setCurValue(fullValue);</span>
      // moment 更改后直接获取值（format）可能拿到是之前值
<span class="cstat-no" title="statement not covered" >      setTimeout(<span class="fstat-no" title="function not covered" >()</span> =&gt; <span class="cstat-no" title="statement not covered" >setInputValue(getInputValue(fullValue)),</span> 0);</span>
    }
&nbsp;
            ...
            &lt;CalendarPart.Panel rangeMode timeMode&gt;
              &lt;CalendarPart.Body&gt;
                &lt;CalendarTable
                  ...
                  showTime={{
                    ...timeProps,
                    caption: Array.isArray(caption) ? caption[0] : <span class="branch-1 cbranch-no" title="branch not covered" >null,</span>
                  }}
                  value={curValue}
                ...
                &lt;CalendarTable
                  ...
                  showTime={{
                    ...timeProps,
                    caption: Array.isArray(caption) ? caption[1] : <span class="branch-1 cbranch-no" title="branch not covered" >null,</span>
                  }}
                  value={curValue}
                  onChange={handleChange}
                /&gt;
