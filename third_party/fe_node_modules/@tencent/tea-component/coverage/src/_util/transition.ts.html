...
<html lang="en">
<head>
    <title>Code coverage report for src/_util/transition.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/_util</a> transition.ts
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-yes">20x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { insertCSS } from "./insert-css";
...
&nbsp;
  <span class="missing-if-branch" title="else path not taken" >E</span>if (!setupTransitions[hash]) {
    setupTransitions[hash] = {
      classNames: name + hash,
      timeout: {
        enter: enterTimeout,
