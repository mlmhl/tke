...
<html lang="en">
<head>
    <title>Code coverage report for src/_util/config-context/with-config.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">All files</a> / <a href="index.html">src/_util/config-context</a> with-config.ts
    </h1>
    <div class='clearfix'>
