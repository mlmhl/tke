...
<html lang="en">
<head>
    <title>Code coverage report for src/domref/DomRef.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/domref</a> DomRef.tsx
    </h1>
    <div class='clearfix'>
...
&nbsp;
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (React.isValidElement(childrenElement)) {
      for (const [propName, propValue] of Object.entries(props)) {
        <span class="missing-if-branch" title="else path not taken" >E</span>if (typeof propValue === "function") {
          // 子节点之前已经有处理函数，则同时调用
...
<span class="cstat-no" title="statement not covered" >          attachProps[propName] = propValue;</span>
        }
      }
