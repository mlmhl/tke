...
<html lang="en">
<head>
    <title>Code coverage report for src/alert/AlertNotice.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/alert</a> AlertNotice.tsx
    </h1>
    <div class='clearfix'>
...
&nbsp;
      ...
      &lt;div className={`${classPrefix}-alert__operational`}&gt;
        {children &amp;&amp; (
          &lt;Button
            type="icon"
            icon={isOpened ? "arrowup" : <span class="branch-1 cbranch-no" title="branch not covered" >"arrowdown"}</span>
            onClick={<span class="fstat-no" title="function not covered" >()</span> =&gt; <span class="cstat-no" title="statement not covered" >setIsOpened(!isOpened)}</span>
          /&gt;
        )}
      &lt;/div&gt;
    &lt;/div&gt;
