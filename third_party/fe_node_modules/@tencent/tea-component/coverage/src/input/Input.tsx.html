...
<html lang="en">
<head>
    <title>Code coverage report for src/input/Input.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/input</a> Input.tsx
    </h1>
    <div class='clearfix'>
...
&nbsp;
    const inputProps = {
      ...
      disabled,
      // 受样式限制 rows 属性没有生效
      style: hasRows ? <span class="branch-0 cbranch-no" title="branch not covered" >{ height: "auto", ...(style || {}) } </span>: style,
      value,
      onChange: <span class="fstat-no" title="function not covered" >(e</span>vent: React.ChangeEvent&lt;InputElements&gt;) =&gt;
<span class="cstat-no" title="statement not covered" >        onChange(event.target.value, { event }),</span>
      ...restProps,
    };
&nbsp;
    return multiline ? (
