...
<html lang="en">
<head>
    <title>Code coverage report for src/form/_example/FormLayoutExample.jsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">All files</a> / <a href="index.html">src/form/_example</a> FormLayoutExample.jsx
    </h1>
    <div class='clearfix'>
        ...
        &lt;Card.Body&gt;
          ...
          &lt;Form hideLabel={hideLabel}&gt;
            &lt;Form.Item label="布局类型"&gt;
              &lt;Segment
                value={layout}
                onChange={<span class="fstat-no" title="function not covered" >la</span>yout =&gt; <span class="cstat-no" title="statement not covered" >setLayout(layout)}</span>
                options={[
            ...
            &lt;Form.Item label="隐藏 Label"&gt;
              &lt;Switch
                value={hideLabel}
                onChange={<span class="fstat-no" title="function not covered" >va</span>lue =&gt; <span class="cstat-no" title="statement not covered" >setHideLabel(value)}</span>
              /&gt;
            &lt;/Form.Item&gt;
          &lt;/Form&gt;
          &lt;hr /&gt;
