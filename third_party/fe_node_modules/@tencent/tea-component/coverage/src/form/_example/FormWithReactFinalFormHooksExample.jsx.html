...
<html lang="en">
<head>
    <title>Code coverage report for src/form/_example/FormWithReactFinalFormHooksExample.jsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">All files</a> / <a href="index.html">src/form/_example</a> FormWithReactFinalFormHooksExample.jsx
    </h1>
    <div class='clearfix'>
...
function getStatus(meta, validating) {
  <span class="missing-if-branch" title="if path not taken" >I</span>if (meta.active &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >validating)</span> {
<span class="cstat-no" title="statement not covered" >    return "validating";</span>
  }
  <span class="missing-if-branch" title="else path not taken" >E</span>if (!meta.touched) {
    return null;
  }
<span class="cstat-no" title="statement not covered" >  return meta.error ? "error" : "success";</span>
}
&nbsp;
export default function FormWithReactFinalFormExample() {
  async function <span class="fstat-no" title="function not covered" >onSubmit(</span>values) {
<span class="cstat-no" title="statement not covered" >    await sleep(1500);</span>
<span class="cstat-no" title="statement not covered" >    alert(JSON.stringify(values));</span>
  }
&nbsp;
  const { form, handleSubmit, validating, submitting } = useForm({
    ...
    validate: ({ name, sex, age, hobbies }) =&gt; ({
      name: name.length &lt; 4 ? "昵称太短了哦" : <span class="branch-1 cbranch-no" title="branch not covered" >undefined,</span>
      sex: !sex ? "请选择性别" : <span class="branch-1 cbranch-no" title="branch not covered" >undefined,</span>
      age: age &lt; 18 ? <span class="branch-0 cbranch-no" title="branch not covered" >"你好像还未成年哦" </span>: undefined,
      hobbies: hobbies.length &lt; 1 ? "请至少选择一个哦" : <span class="branch-1 cbranch-no" title="branch not covered" >undefined,</span>
    }),
  });
&nbsp;
...
<span class="branch-1 cbranch-no" title="branch not covered" >                  name.meta.error</span>
                }
              &gt;
                &lt;Input
                  {...name.input}
              ...
              &lt;Form.Item
                ...
                message={getStatus(sex.meta) === "error" &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >sex.meta.error}</span>
              &gt;
              ...
              &lt;Form.Item
                label="年龄"
                status={age.meta.error ? <span class="branch-0 cbranch-no" title="branch not covered" >"error" </span>: "success"}
