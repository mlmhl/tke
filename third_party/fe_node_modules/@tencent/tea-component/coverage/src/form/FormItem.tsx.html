...
<html lang="en">
<head>
    <title>Code coverage report for src/form/FormItem.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/form</a> FormItem.tsx
    </h1>
    <div class='clearfix'>
...
export function FormItem({
  ...
  return (
    &lt;FormContext.Consumer&gt;
      {({ hideLabel }) =&gt; (
        &lt;div
          className={classNames(`${classPrefix}-form__item`, className)}
          style={style}
        &gt;
          {!hideLabel &amp;&amp; (
            &lt;div
              className={classNames(`${classPrefix}-form__label`, {
          ...
          &gt;
            {children}
            {suffix &amp;&amp; (
<span class="branch-1 cbranch-no" title="branch not covered" >              &lt;div className={`${classPrefix}-form__help-text--inline`}&gt;</span>
                {suffix}
              &lt;/div&gt;
            )}
          &lt;/FormControl&gt;
...
function isAlignLabelTop(
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (align === "top") {
