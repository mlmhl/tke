...
<html lang="en">
<head>
    <title>Code coverage report for src/popconfirm/PopConfirm.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/popconfirm</a> PopConfirm.tsx
    </h1>
    <div class='clearfix'>
...
&nbsp;
  const close = <span class="fstat-no" title="function not covered" >()</span> =&gt; <span class="cstat-no" title="statement not covered" >onVisibleChange(false);</span>
&nbsp;
  return (
    &lt;Bubble
      visible={visible}
      ...
      content={
        &lt;Fragment&gt;
          &lt;div className={`${classPrefix}-popconfirm__body`}&gt;
            &lt;div className={`${classPrefix}-media`}&gt;
              &lt;div className={`${classPrefix}-media__body`}&gt;
                {title &amp;&amp; (
          ...
          {footer &amp;&amp; (
            &lt;div className={`${classPrefix}-popconfirm__footer`}&gt;
              {typeof footer === "function" ? <span class="branch-0 cbranch-no" title="branch not covered" >footer.call(null, close) </span>: footer}
            &lt;/div&gt;
          )}
        &lt;/Fragment&gt;
      }
