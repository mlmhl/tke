...
<html lang="en">
<head>
    <title>Code coverage report for src/tagsearchbox/_example/TagSearchBoxExample.jsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">All files</a> / <a href="index.html">src/tagsearchbox/_example</a> TagSearchBoxExample.jsx
    </h1>
    <div class='clearfix'>
...
<span class="cstat-no" title="statement not covered" >          resolve(values);</span>
  ...
  },
  {
    ...
    key: "5",
    name: "地域",
    values: <span class="fstat-no" title="function not covered" >()</span> =&gt; <span class="cstat-no" title="statement not covered" >values,</span>
  },
  {
    type: "multiple",
    key: "6",
...
&nbsp;
  function <span class="fstat-no" title="function not covered" >onChange(</span>tags) {
<span class="cstat-no" title="statement not covered" >    console.log(tags);</span>
<span class="cstat-no" title="statement not covered" >    setTags(tags);</span>
  }
&nbsp;
  return (
    &lt;TagSearchBox
  ...
  return (
    &lt;div&gt;
      &lt;TagSearchBox
        ...
        onChange={<span class="fstat-no" title="function not covered" >ta</span>gs =&gt; <span class="cstat-no" title="statement not covered" >console.log(tags)}</span>
      /&gt;
