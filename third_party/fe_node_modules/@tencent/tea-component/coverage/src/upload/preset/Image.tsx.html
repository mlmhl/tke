...
<html lang="en">
<head>
    <title>Code coverage report for src/upload/preset/Image.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">All files</a> / <a href="index.html">src/upload/preset</a> Image.tsx
    </h1>
    <div class='clearfix'>
          ...
          &lt;div className={`${classPrefix}-form-upload__info`}&gt;
            {filename &amp;&amp; (
              &lt;div className={`${classPrefix}-form-upload__file`}&gt;
                ...
                {(percent || percent === 0) &amp;&amp; (
<span class="branch-2 cbranch-no" title="branch not covered" >                  &lt;span className={`${classPrefix}-form__help-text--inline`}&gt;</span>
                    {Math.floor(percent)}%
                  &lt;/span&gt;
                )}
              &lt;/div&gt;
