...
<html lang="en">
<head>
    <title>Code coverage report for src/calendar/Calendar.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/calendar</a> Calendar.tsx
    </h1>
    <div class='clearfix'>
...
&nbsp;
  ...
  const [curViewMoment, setCurViewMoment] = useState&lt;Moment&gt;(
    isMoment(value) ? <span class="branch-0 cbranch-no" title="branch not covered" >value </span>: moment()
  );
&nbsp;
  return (
