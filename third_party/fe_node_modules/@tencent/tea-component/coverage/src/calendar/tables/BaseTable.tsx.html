...
<html lang="en">
<head>
    <title>Code coverage report for src/calendar/tables/BaseTable.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">All files</a> / <a href="index.html">src/calendar/tables</a> BaseTable.tsx
    </h1>
    <div class='clearfix'>
...
const Table = withStatics(
  function Table({ caption, children, jumperOptions = <span class="branch-0 cbranch-no" title="branch not covered" >{},</span> type }: TableProps) {
...
export function Cell({
  name,
  value,
  onSelect = <span class="fstat-no" title="function not covered" >()</span> =&gt; <span class="cstat-no" title="statement not covered" >null,</span>
  onOutsideSelect = <span class="fstat-no" title="function not covered" >()</span> =&gt; <span class="cstat-no" title="statement not covered" >null,</span>
  isNow = false,
  outside = false,
  disabled = false,
...
<span class="cstat-no" title="statement not covered" >          onSelect(value, { event });</span>
<span class="cstat-no" title="statement not covered" >          if (outside) {</span>
<span class="cstat-no" title="statement not covered" >            onOutsideSelect(value);</span>
          }
        }
      }}
    &gt;
