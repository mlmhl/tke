...
<html lang="en">
<head>
    <title>Code coverage report for src/calendar/CalendarPart.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/calendar</a> CalendarPart.tsx
    </h1>
    <div class='clearfix'>
...
&nbsp;
export function <span class="fstat-no" title="function not covered" >CalendarHeader(</span>{ style, className, children }: ContainerProps) {
...
&nbsp;
export function <span class="fstat-no" title="function not covered" >CalendarFooter(</span>{
  style,
  className,
  left,
  right,
