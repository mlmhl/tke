...
<html lang="en">
<head>
    <title>Code coverage report for src/transfer/Transfer.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/transfer</a> Transfer.tsx
    </h1>
    <div class='clearfix'>
    ...
    &gt;
      {typeof title !== "undefined" &amp;&amp; (
        &lt;div className={`${classPrefix}-transfer__title`}&gt;
          {typeof title === "string" ? &lt;h4&gt;{title}&lt;/h4&gt; : <span class="branch-1 cbranch-no" title="branch not covered" >title}</span>
        &lt;/div&gt;
      )}
