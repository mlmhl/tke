...
<html lang="en">
<head>
    <title>Code coverage report for src/transfer/_example/TransferExample.jsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">All files</a> / <a href="index.html">src/transfer/_example</a> TransferExample.jsx
    </h1>
    <div class='clearfix'>
  ...
  return (
    &lt;Table
      ...
      addons={[
        scrollable({
          maxHeight: 310,
          onScrollBottom: <span class="fstat-no" title="function not covered" >()</span> =&gt; <span class="cstat-no" title="statement not covered" >console.log("到达底部"),</span>
        }),
        selectable({
          value: targetKeys,
          onChange,
      ...
      leftCell={
        &lt;Transfer.Cell
          ...
          header={
            &lt;SearchBox
              value={inputValue}
              onChange={<span class="fstat-no" title="function not covered" >va</span>lue =&gt; <span class="cstat-no" title="statement not covered" >setInputValue(value)}</span>
            /&gt;
          }
        &gt;
          &lt;SourceTable
...
<span class="branch-1 cbranch-no" title="branch not covered" >                i.instanceName.includes(inputValue)</span>
            )}
            targetKeys={targetKeys}
            onChange={<span class="fstat-no" title="function not covered" >ke</span>ys =&gt; <span class="cstat-no" title="statement not covered" >setTargetKeys(keys)}</span>
          /&gt;
        &lt;/Transfer.Cell&gt;
      }
      rightCell={
        &lt;Transfer.Cell title={`已选择 (${targetKeys.length})`}&gt;
          &lt;TargetTable
            ...
            onRemove={<span class="fstat-no" title="function not covered" >ke</span>y =&gt; <span class="cstat-no" title="statement not covered" >setTargetKeys(targetKeys.filter(<span class="fstat-no" title="function not covered" >i </span>=&gt; <span class="cstat-no" title="statement not covered" >i !== key)</span>)}</span>
          /&gt;
        &lt;/Transfer.Cell&gt;
      }
    /&gt;
...
export default function TransferExample() {
  ...
  const close = <span class="fstat-no" title="function not covered" >()</span> =&gt; <span class="cstat-no" title="statement not covered" >setModalVisible(false);</span>
  return (
    &lt;&gt;
      &lt;section&gt;
        &lt;Button onClick={<span class="fstat-no" title="function not covered" >()</span> =&gt; <span class="cstat-no" title="statement not covered" >setModalVisible(true)}</span>&gt;打开穿梭框&lt;/Button&gt;
