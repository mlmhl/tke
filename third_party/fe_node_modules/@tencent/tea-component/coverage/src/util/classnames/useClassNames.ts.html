...
<html lang="en">
<head>
    <title>Code coverage report for src/util/classnames/useClassNames.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">All files</a> / <a href="index.html">src/util/classnames</a> useClassNames.ts
    </h1>
    <div class='clearfix'>
...
function replace&lt;T&gt;(current: T, prefix: string): T {
  <span class="missing-if-branch" title="else path not taken" >E</span>if (typeof current === "object") {
