...
<html lang="en">
<head>
    <title>Code coverage report for src/layout/LayoutContent.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/layout</a> LayoutContent.tsx
    </h1>
    <div class='clearfix'>
...
export function LayoutContentHeader({
  showBackButton,
  onBackButtonClick = <span class="fstat-no" title="function not covered" >()</span> =&gt; <span class="cstat-no" title="statement not covered" >null,</span>
  title,
  subtitle,
  children,
  operation,
