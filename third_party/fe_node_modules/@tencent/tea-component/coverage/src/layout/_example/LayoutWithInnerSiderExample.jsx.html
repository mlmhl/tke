...
<html lang="en">
<head>
    <title>Code coverage report for src/layout/_example/LayoutWithInnerSiderExample.jsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">All files</a> / <a href="index.html">src/layout/_example</a> LayoutWithInnerSiderExample.jsx
    </h1>
    <div class='clearfix'>
...
&nbsp;
  const getMenuItemProps = id =&gt; ({
    ...
    onClick: <span class="fstat-no" title="function not covered" >()</span> =&gt; <span class="cstat-no" title="statement not covered" >setSelected(id),</span>
  });
&nbsp;
  const getSubMenuItemProps = id =&gt; ({
    selected: subSelected === id,
    onClick: <span class="fstat-no" title="function not covered" >()</span> =&gt; <span class="cstat-no" title="statement not covered" >setSubSelected(id),</span>
  });
&nbsp;
  return (
    &lt;Layout&gt;
        ...
        &lt;Sider&gt;
          &lt;Menu
            back={{
              ...
              onClick: <span class="fstat-no" title="function not covered" >()</span> =&gt; <span class="cstat-no" title="statement not covered" >console.log("back"),</span>
            }}
          &gt;
