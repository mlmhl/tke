...
<html lang="en">
<head>
    <title>Code coverage report for src/segment/_example/SegmentGroupExample.jsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">All files</a> / <a href="index.html">src/segment/_example</a> SegmentGroupExample.jsx
    </h1>
    <div class='clearfix'>
...
&nbsp;
  return (
    &lt;Segment
      ...
      onChange={<span class="fstat-no" title="function not covered" >va</span>lue =&gt; <span class="cstat-no" title="statement not covered" >setValue(parseInt(value, 10))}</span>
      options={options}
      groups={groups}
    /&gt;
  );
