...
<html lang="en">
<head>
    <title>Code coverage report for src/tabs/Tabs.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/tabs</a> Tabs.tsx
    </h1>
    <div class='clearfix'>
...
const getHiddenPanelStyle: (
  ...
  pointerEvents: "none",
  display: "block",
  transform: vertical ? <span class="branch-0 cbranch-no" title="branch not covered" >"translate3d(10px, 0, 0)" </span>: "translate3d(0, 10px, 0)",
});
&nbsp;
...
export function Tabs({
  tabs = <span class="branch-0 cbranch-no" title="branch not covered" >[],</span>
  ...
  if (
    ...
    defaultActiveId = firstAvaliable ? firstAvaliable.id : <span class="branch-1 cbranch-no" title="branch not covered" >null;</span>
  }
&nbsp;
...
&nbsp;
  ...
  if (typeof activeId === "undefined") {
    ...
    // eslint-disable-next-line no-param-reassign
    onActive = (onActive =&gt; <span class="fstat-no" title="function not covered" >(t</span>ab: Tab, evt: React.SyntheticEvent) =&gt; {
<span class="cstat-no" title="statement not covered" >      setInternalActiveId(tab.id);</span>
<span class="cstat-no" title="statement not covered" >      if (typeof onActive === "function") {</span>
<span class="cstat-no" title="statement not covered" >        onActive(tab, evt);</span>
      }
    })(onActive);
  }
&nbsp;
...
&nbsp;
        if (
          ...
          (!destroyInactiveTabPanel &amp;&amp; <span class="branch-4 cbranch-no" title="branch not covered" >panelRenderedSet.has(props.id))</span>
        ) {
          panelChildren.push(
      ...
      } else <span class="missing-if-branch" title="else path not taken" >E</span>if (React.isValidElement(child)) {
        panelChildren.push(React.cloneElement(child, { key: index }));
      } else {
<span class="cstat-no" title="statement not covered" >        panelChildren.push(&lt;div key={index}&gt;{child}&lt;/div&gt;);</span>
      }
    });
