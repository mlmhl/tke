...
<html lang="en">
<head>
    <title>Code coverage report for src/tabs/_example/TabsExample.jsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">All files</a> / <a href="index.html">src/tabs/_example</a> TabsExample.jsx
    </h1>
    <div class='clearfix'>
...
&nbsp;
  return (
    &lt;&gt;
      &lt;section&gt;
        &lt;Tabs tabs={tabs} placement={verticalSwitch.value ? <span class="branch-0 cbranch-no" title="branch not covered" >"left" </span>: "top"}&gt;
          &lt;p&gt;当前选项卡：&lt;/p&gt;
...
function useSwitch(defaultChecked = false) {
  ...
  return { value, onChange: <span class="fstat-no" title="function not covered" >va</span>lue =&gt; <span class="cstat-no" title="statement not covered" >onChange(value) </span>};
}
&nbsp;</pre></td></tr>
</table></pre>
