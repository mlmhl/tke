...
<html lang="en">
<head>
    <title>Code coverage report for src/switch/Switch.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/switch</a> Switch.tsx
    </h1>
    <div class='clearfix'>
...
&nbsp;
  const {
    value,
    disabled,
    onChange = <span class="branch-0 cbranch-no" title="branch not covered" >noop,</span>
    onClick,
    loading,
    tooltip,
    children,
  ...
  let component = (
    ...
    &gt;
      &lt;input
        ...
        onClick={callBoth(
          onClick,
<span class="fstat-no" title="function not covered" >          (e</span>vent: React.MouseEvent&lt;HTMLInputElement&gt;) =&gt; {
            const { checked } = <span class="cstat-no" title="statement not covered" >event.currentTarget;</span>
<span class="cstat-no" title="statement not covered" >            onChange(checked, {</span>
              event,
              check: {
                type: "checkbox",
                ...props,
