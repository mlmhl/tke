...
<html lang="en">
<head>
    <title>Code coverage report for src/bubble/BubbleContent.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/bubble</a> BubbleContent.tsx
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">59x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import React, { forwardRef, Ref, HTMLAttributes } from "react";
...
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (basePlacement === "auto") {
<span class="cstat-no" title="statement not covered" >      basePlacement = "top";</span>
    }
&nbsp;
    const focusPosition = POSITION_MAP[basePlacement] || <span class="branch-1 cbranch-no" title="branch not covered" >"bottom";</span>
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (tooltip) {
