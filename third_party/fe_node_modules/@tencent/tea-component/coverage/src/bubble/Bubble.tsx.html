...
<html lang="en">
<head>
    <title>Code coverage report for src/bubble/Bubble.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/bubble</a> Bubble.tsx
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import React, { useRef, useLayoutEffect } from "react";
&nbsp;
...
&nbsp;
  const deps = Array.isArray(updateDeps) ? updateDeps : <span class="branch-1 cbranch-no" title="branch not covered" >[content];</span>
  useLayoutEffect(
    () =&gt; () =&gt; {
      <span class="missing-if-branch" title="if path not taken" >I</span>if (scheduleUpdateRef.current) {
<span class="cstat-no" title="statement not covered" >        scheduleUpdateRef.current();</span>
      }
    },
...
&nbsp;
  return (
    &lt;Popover
      ...
      overlay={<span class="fstat-no" title="function not covered" >({</span> scheduleUpdate, placement }) =&gt; {
<span class="cstat-no" title="statement not covered" >        scheduleUpdateRef.current = scheduleUpdate;</span>
<span class="cstat-no" title="statement not covered" >        if (!content &amp;&amp; content !== 0) {</span>
