...
<html lang="en">
<head>
    <title>Code coverage report for src/regionselect/RegionOption.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/regionselect</a> RegionOption.tsx
    </h1>
    <div class='clearfix'>
...
<span class="cstat-no" title="statement not covered" >    props = context.inject(props); </span>// eslint-disable-line no-param-reassign
  }
&nbsp;
  ...
  return (
    ...
    &gt;
      ...
      &lt;span className={`${classPrefix}-region__name`}&gt;
        {children}
        {dot &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >&lt;i className={`${classPrefix}-region__new`} /&gt;}</span>
      &lt;/span&gt;
    &lt;/div&gt;
  );
}
