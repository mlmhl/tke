...
<html lang="en">
<head>
    <title>Code coverage report for src/transition/_example/TransitionExample.jsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">All files</a> / <a href="index.html">src/transition/_example</a> TransitionExample.jsx
    </h1>
    <div class='clearfix'>
...
function TransitionCase({ title, children }) {
  ...
  return (
    &lt;Col style={{ textAlign: "center" }}&gt;
      &lt;p&gt;
        &lt;Switch value={visible} onChange={<span class="fstat-no" title="function not covered" >vi</span>sible =&gt; <span class="cstat-no" title="statement not covered" >setVisible(visible)}</span>&gt;
          {title}
        &lt;/Switch&gt;
      &lt;/p&gt;
      {children(visible)}
