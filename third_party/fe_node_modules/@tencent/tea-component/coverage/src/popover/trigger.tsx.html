...
<html lang="en">
<head>
    <title>Code coverage report for src/popover/trigger.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/popover</a> trigger.tsx
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-no">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { ReferenceObject } from "popper.js";
...
&nbsp;
  listen(<span class="fstat-no" title="function not covered" >()</span> =&gt; <span class="cstat-no" title="statement not covered" >visible &amp;&amp; setVisible(false, closeDelay))</span>;
&nbsp;
  return render({
    overlayProps: {},
    childrenProps: {
      onClick: <span class="fstat-no" title="function not covered" >()</span> =&gt; <span class="cstat-no" title="statement not covered" >setVisible(!visible, openDelay),</span>
    },
  });
}
&nbsp;
 ...
 * 表示空的触发交互
 */
export function <span class="fstat-no" title="function not covered" >EmptyTrigger(</span>props: TriggerProps) {
<span class="cstat-no" title="statement not covered" >  return props.render({ overlayProps: {}, childrenProps: {} });</span>
}
&nbsp;</pre></td></tr>
</table></pre>
