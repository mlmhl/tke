...
<html lang="en">
<head>
    <title>Code coverage report for src/popover/Popover.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/popover</a> Popover.tsx
    </h1>
    <div class='clearfix'>
...
&nbsp;
  ...
  useParentScroll(
    childrenRef,
    visible &amp;&amp; closeOnScroll &amp;&amp; (<span class="fstat-no" title="function not covered" ><span class="branch-2 cbranch-no" title="branch not covered" >()</span> =&gt; <span class="cstat-no" title="statement not covered" >setVisible(false, closeDelay))</span></span>
  );
&nbsp;
  let Trigger: Trigger;
...
&nbsp;
  ...
  // fallback
  Trigger = Trigger || <span class="branch-1 cbranch-no" title="branch not covered" >buildinTriggers.empty;</span>
&nbsp;
  return (
    &lt;Trigger
      {...triggerExtraProps}
        ...
        &lt;Overlay
          layers={[
            &lt;Overlay.Layer
              ...
              overlayProps={{
                ...overlayProps,
                className: classNames(overlayProps.className, overlayClassName),
                style: mergeStyle(
                  {
                    // 已经隐藏之后，动画过程不响应事件
