...
<html lang="en">
<head>
    <title>Code coverage report for src/popover/useDelayVisible.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/popover</a> useDelayVisible.ts
    </h1>
    <div class='clearfix'>
...
&nbsp;
  ...
  const setVisible = (nextVisible: boolean, delay = <span class="branch-0 cbranch-no" title="branch not covered" >0)</span> =&gt;
