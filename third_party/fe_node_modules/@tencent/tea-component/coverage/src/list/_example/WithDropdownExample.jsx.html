...
<html lang="en">
<head>
    <title>Code coverage report for src/list/_example/WithDropdownExample.jsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">All files</a> / <a href="index.html">src/list/_example</a> WithDropdownExample.jsx
    </h1>
    <div class='clearfix'>
...
export default function ListExample() {
  return (
    &lt;Dropdown button="点击展开" appearance="button" clickClose={false}&gt;
      {close =&gt; (
        &lt;List type="option"&gt;
