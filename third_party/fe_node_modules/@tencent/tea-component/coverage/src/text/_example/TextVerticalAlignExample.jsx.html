...
<html lang="en">
<head>
    <title>Code coverage report for src/text/_example/TextVerticalAlignExample.jsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">All files</a> / <a href="index.html">src/text/_example</a> TextVerticalAlignExample.jsx
    </h1>
    <div class='clearfix'>
...
&nbsp;
  const select = (
    &lt;Select
      ...
      value={compare}
      onChange={<span class="fstat-no" title="function not covered" >co</span>mpare =&gt; <span class="cstat-no" title="statement not covered" >setCompare(compare)}</span>
    /&gt;
  );
&nbsp;
  return (
