...
<html lang="en">
<head>
    <title>Code coverage report for src/collapse/CollapsePanel.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/collapse</a> CollapsePanel.tsx
    </h1>
    <div class='clearfix'>
...
export function CollapsePanel({
  ...
  const {
    ...
    iconPosition = <span class="branch-0 cbranch-no" title="branch not covered" >"left",</span>
  } = useContext(CollapseContext);
  const active = activeIds.includes(id);
  const top = position === "top";
&nbsp;
  function <span class="fstat-no" title="function not covered" >handleClick(</span>event: React.MouseEvent) {
    const context = <span class="cstat-no" title="statement not covered" >{ event };</span>
<span class="cstat-no" title="statement not covered" >    if (active) {</span>
<span class="cstat-no" title="statement not covered" >      onActive(activeIds.filter(<span class="fstat-no" title="function not covered" >ac</span>tiveId =&gt; <span class="cstat-no" title="statement not covered" >activeId !== id)</span>, context);</span>
    } else {
<span class="cstat-no" title="statement not covered" >      onActive([...activeIds, id], context);</span>
    }
  }
&nbsp;
  return (
