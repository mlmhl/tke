...
<html lang="en">
<head>
    <title>Code coverage report for src/menu/SubMenu.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/menu</a> SubMenu.tsx
    </h1>
    <div class='clearfix'>
...
&nbsp;
  ...
  let activeIcon;
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof icon === "string") {
<span class="cstat-no" title="statement not covered" >    defaultIcon = icon;</span>
<span class="cstat-no" title="statement not covered" >    activeIcon = icon;</span>
  }
&nbsp;
  ...
  return (
    ...
    &gt;
      &lt;a
        ...
        onClick={<span class="fstat-no" title="function not covered" >()</span> =&gt; <span class="cstat-no" title="statement not covered" >onOpenedChange(!opened)}</span>
      &gt;
        {defaultIcon &amp;&amp; (
          &lt;img
