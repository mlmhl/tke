...
<html lang="en">
<head>
    <title>Code coverage report for src/menu/_example/MenuWithRouterExample.jsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">All files</a> / <a href="index.html">src/menu/_example</a> MenuWithRouterExample.jsx
    </h1>
    <div class='clearfix'>
...
&nbsp;
function <span class="fstat-no" title="function not covered" >Content(</span>{ match }) {
  const path = <span class="cstat-no" title="statement not covered" >match &amp;&amp; match.path;</span>
