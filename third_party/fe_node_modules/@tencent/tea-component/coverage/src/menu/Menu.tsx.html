...
<html lang="en">
<head>
    <title>Code coverage report for src/menu/Menu.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/menu</a> Menu.tsx
    </h1>
    <div class='clearfix'>
...
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (Array.isArray(icon)) {
      // eslint-disable-next-line
<span class="cstat-no" title="statement not covered" >      icon = icon[0];</span>
    }
&nbsp;
    const renderBack =
      typeof back === "object"
        ? () =&gt; {
            const { title, description, onClick = <span class="fstat-no" title="function not covered" ><span class="branch-0 cbranch-no" title="branch not covered" >()</span> =&gt; <span class="cstat-no" title="statement not covered" >null,</span></span> tooltip } = back;
            const titleList = (
...
<span class="branch-1 cbranch-no" title="branch not covered" >                  titleList</span>
                )}
              &lt;/div&gt;
            );
          }
      ...
      &lt;&gt;
        &lt;div
          className={classNames(`${classPrefix}-menu`, className, {
            ...
            [`${classPrefix}-menu-is-collapsed`]: collapsed &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >!hovered,</span>
          })}
          style={style}
        &gt;
          &lt;div
            className={`${classPrefix}-menu__header`}
            onMouseEnter={<span class="fstat-no" title="function not covered" >()</span> =&gt; <span class="cstat-no" title="statement not covered" >collapsed &amp;&amp; setHovered(true)}</span>
            onMouseLeave={<span class="fstat-no" title="function not covered" >()</span> =&gt; <span class="cstat-no" title="statement not covered" >collapsed &amp;&amp; setHovered(false)}</span>
          &gt;
            {!!title &amp;&amp; (
              &lt;div className={`${classPrefix}-menu__title`}&gt;
                ...
                &lt;h2 className={`${classPrefix}-h2`}&gt;
                  {title}
                  {!!tag &amp;&amp; (
<span class="branch-1 cbranch-no" title="branch not covered" >                    &lt;div className={`${classPrefix}-tag`}&gt;</span>
                      &lt;span&gt;{tag}&lt;/span&gt;
                    &lt;/div&gt;
                  )}
                &lt;/h2&gt;
          ...
          {!!collapsable &amp;&amp; (
            &lt;div className={`${classPrefix}-menu__footer`}&gt;
              &lt;div
                ...
                onClick={<span class="fstat-no" title="function not covered" >()</span> =&gt; <span class="cstat-no" title="statement not covered" >onCollapsedChange(!collapsed)}</span>
              &gt;
