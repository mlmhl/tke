import { AppUserData, AppUserIdentityInfo } from "./current";
import { PermitedProjectInfo, ProjectItem } from "./project";
import { UserEmitter } from "./event";
export declare const user: AppUserBridge & UserEmitter;
/**
 * `app.user` 导出的接口
 */
export interface AppUserBridge extends GlobalUserInfo {
    /**
     * 获取当前登录用户的信息
     *
     * @example
